...
<section>
	<h2 class="text-lg font-semibold text-ink dark:text-tavern-text mb-4">Sync Status</h2>
	<div
	...
	>
		<div class="grid gap-3 md:grid-cols-2">
			<div class="rounded border border-border dark:border-tavern-border p-3">
				<p class="text-xs text-ink-muted dark:text-tavern-muted">Connection</p>
				<p class="mt-1 text-sm font-semibold text-ink dark:text-tavern-text">
					{describeIndicator()}
				</p>
			</div>
			<div class="rounded border border-border dark:border-tavern-border p-3">
				<p class="text-xs text-ink-muted dark:text-tavern-muted">Pending Queue</p>
				<p class="mt-1 text-sm font-semibold text-ink dark:text-tavern-text">
					{syncState.queueDepth} item{syncState.queueDepth === 1 ? '' : 's'}
				</p>
			</div>
			<div class="rounded border border-border dark:border-tavern-border p-3">
				<p class="text-xs text-ink-muted dark:text-tavern-muted">Conflicts</p>
				<p class="mt-1 text-sm font-semibold text-ink dark:text-tavern-text">
					{syncState.conflictCount}
				</p>
			</div>
			<div class="rounded border border-border dark:border-tavern-border p-3">
				<p class="text-xs text-ink-muted dark:text-tavern-muted">Last Sync</p>
				<p class="mt-1 text-sm font-semibold text-ink dark:text-tavern-text">
		...
		<div class="grid gap-3 lg:grid-cols-[1fr_auto_auto] lg:items-end">
			<label class="text-xs text-ink-muted dark:text-tavern-muted">
				...
				<select
					class="mt-1 w-full rounded border border-border dark:border-tavern-border bg-white dark:bg-tavern-surface-alt px-2 py-1.5 text-sm text-ink dark:text-tavern-text"
...
<section>
	<h2 class="text-lg font-semibold text-ink dark:text-tavern-text mb-4">Conflict Resolution</h2>
	<div
		class="rounded-lg border border-border dark:border-tavern-border bg-surface dark:bg-tavern-surface p-4 space-y-4"
	>
		{#if syncState.conflicts.length === 0}
			<p class="text-sm text-ink-muted dark:text-tavern-muted">No conflicts pending.</p>
		{:else}
			<div class="grid gap-4 lg:grid-cols-[280px_1fr]">
				<div class="rounded border border-border dark:border-tavern-border overflow-hidden">
					<ul
						class="divide-y divide-border dark:divide-tavern-border max-h-[28rem] overflow-y-auto"
					>
				...
				{#if selectedConflict}
					<div class="space-y-4">
						...
						<div class="grid gap-3 md:grid-cols-3">
							<div>
								<p class="text-xs font-medium text-ink-muted dark:text-tavern-muted mb-1">
									Ancestor
								</p>
								<textarea
									class="h-48 w-full rounded border border-border dark:border-tavern-border bg-surface-alt dark:bg-tavern-surface-alt px-2 py-1.5 text-xs font-mono text-ink dark:text-tavern-text"
									readonly
									value={selectedConflict.ancestorNote?.content ?? ''}
								></textarea>
							</div>
							<div>
								<p class="text-xs font-medium text-ink-muted dark:text-tavern-muted mb-1">Local</p>
								<textarea
									class="h-48 w-full rounded border border-border dark:border-tavern-border bg-surface-alt dark:bg-tavern-surface-alt px-2 py-1.5 text-xs font-mono text-ink dark:text-tavern-text"
									readonly
							...
							<div>
								<p class="text-xs font-medium text-ink-muted dark:text-tavern-muted mb-1">Remote</p>
								<textarea
									class="h-48 w-full rounded border border-border dark:border-tavern-border bg-surface-alt dark:bg-tavern-surface-alt px-2 py-1.5 text-xs font-mono text-ink dark:text-tavern-text"
									readonly
						...
						<div>
							<label
								for="sync-merge-draft"
								class="block text-xs font-medium text-ink-muted dark:text-tavern-muted mb-1"
							>
								Manual merged result
							</label>
							<textarea
								id="sync-merge-draft"
								class="h-48 w-full rounded border border-border dark:border-tavern-border bg-white dark:bg-tavern-surface-alt px-2 py-1.5 text-xs font-mono text-ink dark:text-tavern-text"
