			...
			<section>
				...
				>
					<table class="w-full text-sm">
						...
						<tbody>
							{#each [['Ctrl+N', 'Create new note'], ['Ctrl+P', 'Quick switcher'], ['Ctrl+D', 'Open dice tray'], ['Ctrl+Shift+Space', 'Quick reference HUD'], ['Ctrl+B', 'Toggle sidebar / Bold (in editor)'], ['Ctrl+Shift+F', 'Global search'], ['Ctrl+S', 'Save note (in editor)'], ['Ctrl+I', 'Italic (in editor)'], ['Ctrl+E', 'Inline code (in editor)'], ['Ctrl+K', 'Insert link (in editor)'], ['Ctrl+Z', 'Undo (in editor)'], ['Ctrl+Shift+Z', 'Redo (in editor)']] as [shortcut, action] (shortcut)}
