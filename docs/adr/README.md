...
| ADR-014 | Accepted | V2 runtime implementation in `apps/v2` uses a SvelteKit/Svelte 5 app with a package-local processing core and local prototype persistence.           | [014-v2-stack-and-subproject-boundary.md](./014-v2-stack-and-subproject-boundary.md)                     |
