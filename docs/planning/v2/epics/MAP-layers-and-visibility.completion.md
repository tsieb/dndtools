...
| Public core surface | `apps/v2/packages/core/src/index.ts` (MAP-005/006/007/016 export blocks) | existing `tests/boundary.test.ts` / `tests/type-runtime-split.test.ts` (still green) |
