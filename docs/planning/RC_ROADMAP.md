...
| ----------- | ----------- | ---------------------------------------------------------------------------- | ---- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| RC-STB-1.1  | Stabilize   | Land the pending infra/ADR-028 change                                        | S    | P0      | none                                                                                                                                         |        |
| RC-STB-1.2  | Stabilize   | Prune and record branches                                                    | S    | P0      | 1.1                                                                                                                                          |        |
| RC-STB-1.3  | Stabilize   | Pause or re-target the visual-review loop                                    | S    | P0      | none                                                                                                                                         |        |
| RC-STB-2.1  | Stabilize   | Split `Settings.tsx` (4,989 lines) into `screens/settings/`                  | L    | P0      | —                                                                                                                                            |        |
| RC-STB-2.2  | Stabilize   | Split `Player.tsx` (2,677) and `PlayerView.tsx` (2,282)                      | M    | P0      | —                                                                                                                                            |        |
| RC-STB-2.3  | Stabilize   | Split `Extensions.tsx` (2,611)                                               | M    | P0      | —                                                                                                                                            |        |
| RC-STB-2.4  | Stabilize   | Split `CharBuilder.tsx` (2,470)                                              | M    | P0      | —                                                                                                                                            |        |
| RC-STB-2.5  | Stabilize   | Split `Session.tsx` (2,295)                                                  | M    | P0      | —                                                                                                                                            |        |
| RC-STB-2.7  | Stabilize   | Add the file-size gate                                                       | S    | P0      | 2.1–2.6                                                                                                                                      |        |
| RC-STB-3.1  | Stabilize   | Re-status the initiative files                                               | M    | P0      | —                                                                                                                                            |        |
| RC-STB-3.2  | Stabilize   | Fix the known-wrong reference docs                                           | S    | P0      | —                                                                                                                                            |        |
| RC-STB-3.3  | Stabilize   | Restructure FEATURE-GAPS.md into an inventory                                | M    | P0      | —                                                                                                                                            |        |
| RC-STB-4.1  | Stabilize   | ADR-029 System Packages as the rules contract                                | M    | P0      | none                                                                                                                                         |        |
| RC-STB-4.2  | Stabilize   | ADR-030 Custom-widget runtime host and authoring model                       | M    | P0      | none                                                                                                                                         |        |
| RC-STB-4.3  | Stabilize   | ADR-031 Scene layout history                                                 | M    | P0      | none                                                                                                                                         |        |
| RC-STB-4.4  | Stabilize   | ADR-032 Internationalization architecture                                    | M    | P0      | none                                                                                                                                         |        |
| RC-STB-4.5  | Stabilize   | ADR-033 Combat on the map                                                    | M    | P0      | none                                                                                                                                         |        |
| RC-SYS-1.1  | Systems     | `SystemPackage` schema + state slice                                         | L    | P1      | STB-4.1                                                                                                                                      |        |
| RC-SYS-1.2  | Systems     | Built-in packages: D&D 5e reference and Generic/narrative                    | M    | P1      | 1.1                                                                                                                                          |        |
| RC-SYS-1.4  | Systems     | Actor-scoped read: `getActiveSystemForActor`, `resolveVocabulary`            | S    | P1      | 1.1                                                                                                                                          |        |
| RC-SYS-2.1  | Systems     | Characters read attributes/skills/derived from the package                   | L    | P1      | 1.2, 1.4                                                                                                                                     |        |
| RC-SYS-2.2  | Systems     | Resources and rest recovery from the package                                 | M    | P1      | 2.1                                                                                                                                          |        |
| RC-SYS-2.3  | Systems     | Conditions from the package                                                  | M    | P1      | 1.2                                                                                                                                          |        |
| RC-SYS-2.4  | Systems     | Dice model and turn model from the package                                   | M    | P2      | 1.2                                                                                                                                          |        |
| RC-SYS-2.5  | Systems     | Creature schema, encounter math, compendium mapping from the package         | M    | P2      | 1.2                                                                                                                                          |        |
| RC-SYS-2.6  | Systems     | Vocabulary everywhere                                                        | M    | P2      | 1.4, UX-1.2                                                                                                                                  |        |
| RC-SYS-2.7  | Systems     | Widget bodies and templates read the package                                 | S    | P2      | WID-1.3                                                                                                                                      |        |
| RC-SYS-3.1  | Systems     | System Package Picker (the front door)                                       | M    | P2      | 1.3, STB-2.3                                                                                                                                 |        |
| RC-SYS-3.2  | Systems     | Switch dry-run dialog v2                                                     | S    | P2      | 1.3, 3.1                                                                                                                                     |        |
| RC-SYS-3.3  | Systems     | System builder (fork & edit)                                                 | L    | P2      | 1.3, 3.1                                                                                                                                     |        |
| RC-SYS-3.4  | Systems     | Package export/import and marketplace listing kind                           | M    | P2      | 1.3, CLD-4.1                                                                                                                                 |        |
| RC-SYS-3.5  | Systems     | Pathfinder 2e sample package (data only, community-style)                    | M    | P2      | 1.2                                                                                                                                          |        |
| RC-WID-1.1  | Widgets     | Unified widget render resolver                                               | M    | P1      | STB-2.6                                                                                                                                      |        |
| RC-WID-1.2  | Widgets     | Template renderers for all eight template kinds                              | L    | P1      | 1.1                                                                                                                                          |        |
| RC-WID-1.3  | Widgets     | Iframe sandbox host for `custom-html-js`                                     | L    | P1      | 1.1, STB-4.2                                                                                                                                 |        |
| RC-WID-1.4  | Widgets     | Worker sandbox (data-only widgets)                                           | M    | P2      | 1.3                                                                                                                                          |        |
| RC-WID-1.5  | Widgets     | Trust review command + UI                                                    | M    | P1      | STB-4.2                                                                                                                                      |        |
| RC-WID-1.6  | Widgets     | Real starter library                                                         | M    | P2      | 1.2, 1.3, 1.5                                                                                                                                |        |
| RC-WID-2.1  | Widgets     | Builder shell and definition editor                                          | L    | P1      | 1.2, STB-2.3                                                                                                                                 |        |
| RC-WID-2.2  | Widgets     | Data step: bindings, data queries, computed fields                           | M    | P1      | 2.1                                                                                                                                          |        |
| RC-WID-2.3  | Widgets     | Config-fields and commands steps                                             | M    | P2      | 2.1                                                                                                                                          |        |
| RC-WID-2.4  | Widgets     | Style step                                                                   | S    | P2      | 2.1, DSN-1.1                                                                                                                                 |        |
| RC-WID-2.5  | Widgets     | Advanced step: custom HTML/JS                                                | M    | P2      | 1.3, 2.1                                                                                                                                     |        |
| RC-WID-2.6  | Widgets     | Edit-in-place from the canvas                                                | S    | P2      | 2.1, CAN-4.2                                                                                                                                 |        |
| RC-WID-2.7  | Widgets     | Export/share and versioning UX                                               | S    | P2      | 2.1                                                                                                                                          |        |
| RC-WID-3.1  | Widgets     | MCP tool `widget.package.propose`                                            | M    | P2      | 1.2, AI-1.2                                                                                                                                  |        |
...
| RC-WID-4.1  | Widgets     | Missing builtin bodies                                                       | M    | P2      | 1.1                                                                                                                                          |        |
| RC-WID-4.2  | Widgets     | Per-widget operate controls on the canvas                                    | M    | P2      | 1.1                                                                                                                                          |        |
| RC-WID-4.3  | Widgets     | Widget bindings inspector                                                    | M    | P2      | CAN-4.1                                                                                                                                      |        |
| RC-CAN-1.1  | Canvas      | Core inverse builders for scene layout ops                                   | M    | P1      | STB-4.3                                                                                                                                      |        |
| RC-CAN-1.2  | Canvas      | `scene.restore-widget` + tombstones                                          | M    | P1      | 1.1                                                                                                                                          |        |
| RC-CAN-1.3  | Canvas      | App-side undo/redo stack for both canvases                                   | M    | P1      | 1.1, 1.2                                                                                                                                     |        |
...
| RC-CAN-3.1  | Canvas      | Fit / Comfortable / Detail zoom presets                                      | M    | P2      | —                                                                                                                                            |        |
...
| RC-MAP-1.1  | Maps        | Session combat tokens                                                        | L    | P1      | STB-4.5                                                                                                                                      |        |
| RC-MAP-1.2  | Maps        | AoE templates and measurement as ephemeral session state                     | M    | P1      | 1.1                                                                                                                                          |        |
| RC-MAP-1.3  | Maps        | Movement range and path                                                      | M    | P1      | 1.1, SYS-1.1                                                                                                                                 |        |
| RC-MAP-1.4  | Maps        | Party location and atlas breadcrumb reads                                    | S    | P1      | —                                                                                                                                            |        |
| RC-MAP-2.1  | Maps        | Token layer UI                                                               | L    | P2      | 1.1                                                                                                                                          |        |
...
| RC-AI-1.1   | AI          | Transport abort + streaming polish                                           | S    | P1      | —                                                                                                                                            |        |
| RC-AI-1.3   | AI          | Read tools: continuity bundle, coverage gaps, stale notes, cluster momentum  | S    | P1      | —                                                                                                                                            |        |
...
| RC-UX-1.1   | UX          | Message-key catalogs and `t()` API                                           | M    | P1      | STB-4.4                                                                                                                                      |        |
| RC-UX-1.2   | UX          | Migrate every user-visible string                                            | L    | P1      | 1.1                                                                                                                                          |        |
...
| RC-ENG-1.1  | Engineering | Perf measurement pipeline                                                    | M    | P1      | —                                                                                                                                            |        |
| RC-ENG-1.2  | Engineering | Bundle budget enforcement + route-level analysis                             | S    | P1      | —                                                                                                                                            |        |
| RC-ENG-2.1  | Engineering | Tiered branch model + smoke gate                                             | S    | P1      | —                                                                                                                                            |        |
| RC-ENG-2.2  | Engineering | Test suite performance                                                       | M    | P2      | —                                                                                                                                            |        |
...
| RC-ENG-4.3  | Engineering | Dependency hygiene                                                           | S    | P0      | —                                                                                                                                            |        |
