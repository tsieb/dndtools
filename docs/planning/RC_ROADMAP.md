...
- **RC-CLD-2.1 — Stripe billing (ADR-027 → Accepted).** `L` · P2 · External: Stripe account.
  ...
  **Status 2026-09-10 — code complete, deployed to dev, fail-closed; blocked(Stripe account).**
  Webhook Lambda + Checkout/portal routes + web-only client flow + `pnpm billing:bootstrap` /
  `pnpm billing:verify` shipped with 43 contract tests driven by real Stripe signatures. Remaining
  is operator-only: open the Stripe account, run the bootstrap per stage, run the dev verify (its
  output is the evidence that flips ADR-027 to Accepted), add privacy/terms pages before prod.
  Runbook: `docs/runbooks/stripe-billing.md`.
...
| RC-CAN-4.5  | Canvas      | Map tile                                                                     | L    | P2      | MAP-2.3, WID-1.1                                                                                                                             | in progress                     |
...
| RC-MAP-2.4  | Maps        | Live fog reveal to players with animation and sound cue                      | M    | P2      | 2.3, AUD-3.2                                                                                                                                 | in progress                     |
...
| RC-CLD-2.1  | Cloud       | Stripe billing (ADR-027 → Accepted)                                          | L    | P2      | (external)                                                                                                                                   | code done; blocked(Stripe acct) |
| RC-CLD-2.2  | Cloud       | Cloud-Enhanced phase 2 security review                                       | M    | P2      | —                                                                                                                                            | in progress                     |
...
| RC-CLD-4.1  | Cloud       | Marketplace listing kinds and module format                                  | M    | P2      | —                                                                                                                                            | in progress                     |
...
| RC-PLT-2.1  | Platform    | PWA                                                                          | M    | P2      | —                                                                                                                                            | in progress                     |
