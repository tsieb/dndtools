...
## Status: SVELTE-ERA PLAN — React status tracked in RC_ROADMAP §17

> **Implementation note (2026-07-15, re-verified 2026-09-04):** This initiative's root-cause and
> story paths describe the retired Svelte app and are preserved as planning history, not a
> completion claim. The maintained implementation is React: `apps/gm-react/src/app/AppShell.tsx`,
> `src/app/nav.ts`, `src/styles/index.css`, and `src/platform/capabilities.ts`. Android adds
> edge-to-edge safe areas, 48dp targets, native Back, and keyboard-aware layouts; see
> [ADR-006](../../adr/006-multi-platform-approach-electron-capacitor.md) and the
> [Android alpha runbook](../../runbooks/android-alpha.md). Remaining gaps (signing, auto-update,
> PWA, iOS) are tracked as RC-PLT-1.1–3.1 in `docs/planning/RC_ROADMAP.md` §17.
