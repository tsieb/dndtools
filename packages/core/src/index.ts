...
// SEC-008 / PLAT-010 / CON-004 registry-gate pattern, wired into `scripts/quality-gates.ts` (`pnpm gates`).
export type {
...
// registry-gate pattern, wired into `scripts/quality-gates.ts` (`pnpm gates`).
export type {
	EnforcementPoint,
...
// re-implements them. Mirrors the SEC-008/CON-003/004/006 registry-gate pattern, wired into `pnpm gates`.
export type {
	AuthoritativeOwner,
...
// --- RC-SYS-1.1 — the SYSTEM PACKAGE model (append-only block) ----------------------------------
// The declarative rules system a campaign plays: vocabulary, attributes, resources, conditions,
// dice, turn order, creature fields, advancement, skills and derived values, plus the pure formula
// evaluator every derivation goes through. See `state/system-package.ts` for why it holds no code.
export type {
	FormulaFailureReason,
	FormulaResult,
	FormulaScope,
	LegacyActiveSystemPackage,
	SystemAdvancement,
	SystemAdvancementModel,
	SystemAdvantageSemantics,
	SystemAttribute,
	SystemAttributeDerivation,
	SystemCondition,
...
export {
	systemAdvancementSchema,
	systemAttributeSchema,
	systemConditionSchema,
	systemCreatureFieldSchema,
	systemCritRulesSchema,
	systemDerivedValueSchema,
	systemDiceSchema,
	systemPackageSchema,
	systemResourceSchema,
	systemSkillSchema,
	systemTurnModelSchema,
