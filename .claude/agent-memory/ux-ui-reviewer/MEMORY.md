...
- [Map/atlas cluster (re-verified 2026-07-30 @ 8138156b)](reference_map_editor_cluster.md) — editor notice/Tabs/active-layer now FIXED; 10 STILL-OPEN w/ current line#s: single-flight `run()` slider traps, FeatureShape flattens all props, hidden fog brush size, Atlas notice is the un-fixed twin + never cleared, zero `:hover` in ANY src css.
