...
export const API = 'https://app-api.e2e.invalid/dev';
export const CRYPT = '11111111-1111-4111-8111-111111111111';
 ...
 */
export async function serveMarketplace(page: Page, owned = false): Promise<Marketplace> {
...
export async function openDiscover(page: Page): Promise<void> {
