...
export const en = {
	...
	'mapEdit.tokenPlaced': 'Token placed.',
	'mapEdit.fogRevealed': 'Fog revealed.',
	'mapEdit.fogConcealed': 'Fog concealed.',
	'mapEdit.wallAdded': 'Wall added ({count} points).',
	'mapEdit.routeAdded': 'Route added.',
	'mapEdit.erased': 'Erased {count} features.',
	'mapEdit.scattered': 'Scattered {count} objects.',
	'mapEdit.painted': 'Painted terrain.',
	'mapEdit.roomAdded': 'Room added.',
	'mapEdit.objectPlaced': 'Placed object.',
	'mapEdit.lightPlaced': 'Placed light.',
	'mapEdit.doorPlaced': 'Placed door.',
	'mapEdit.labelPlaced': 'Placed label.',
	'mapEdit.cellFilled': 'Filled a cell.',
	'mapEdit.selected': '{count} selected.',
	'mapEdit.noFloor': 'No floor geometry to derive from. Paint rooms or generate a map first.',
	'mapEdit.exported': 'UVTT scene exported.',
	'mapEdit.selectedName': 'Selected “{name}”.',

	'atlas.noMapSelected': 'No map selected',
	'atlas.noDescription': 'No description',
	'atlas.linkUnavailable': 'This link points at a map that isn’t available to you.',
	'atlas.actionFailed': 'The action could not be completed. Try again.',
	'atlas.poiDeleted': 'Point of interest “{name}” deleted',
	'atlas.poiRestored': '“{name}” restored',
	'atlas.restoreFailed': 'The point of interest couldn’t be restored — try again.',
	'atlas.linkCopied': 'Link copied — opening it highlights this point of interest on the map.',
	'atlas.linkCopyFailed': 'The link couldn’t be copied — copy it manually: {url}',
	'atlas.noPlayers': 'No players yet — add players in Settings → Players before projecting a map.',
	'atlas.projected': 'Projected “{name}” to {count, plural, one {# player} other {# players}}.',
	'atlas.layerName': 'Layer {count}',
	'mapEditor.namedDialog': 'Map editor — {name}',
	'mapEditor.generateSheet': 'Generate map',
	'mapEditor.detailsSheet': 'Map details',
	'mapEditor.resizeHint':
		'Drag the resize handle or use the arrow keys. Back closes this sheet first.',
	'mapEditor.unavailableHint': 'Return to the Atlas to choose a map you can view.',
	'mapEditor.exportCancelled': 'Map export cancelled.',
	'mapEditor.exportShared': 'Map sent to the Android share/save sheet.',
	'mapEditor.exported': 'Map exported for other VTTs (.dd2vtt).',
	'mapEditor.exportFailed': 'The map could not be exported. Check available storage and try again.',
	'mapEditor.projectFailed': 'The map couldn’t be projected — try again.',
	'mapEditor.projectAnnounced': 'Projected to {count, plural, one {# player} other {# players}}.',
	'mapEditor.exportTitle': 'Export {name}',
	...
	'vaults.title': 'Local vaults',
	'vaults.description': 'Keep each campaign in its own vault on this device.',
	'vaults.current': 'Current',
	'vaults.name': 'Vault name',
	'vaults.create': 'Create vault',
	'vaults.rename': 'Rename vault',
	...
	'sceneDisplay.saving': 'Updating display…',
	'sceneDisplay.saved': 'Display saved.',
	'sceneDisplay.readOnly': 'Player preview is read-only.',
	'sceneDisplay.openFailed': 'The scene display couldn’t open. Try again.',
	'sceneDisplay.mood.combat': 'Combat',
	'sceneDisplay.mood.exploration': 'Exploration',
	'sceneDisplay.mood.mystery': 'Mystery',
	'sceneDisplay.mood.social': 'Social',
	'sceneDisplay.mood.rest': 'Rest',
	'sceneDisplay.waiting': 'Waiting for the scene',
	'sceneDisplay.waitingHelp': 'Keep the main window open to show a scene here.',
	...
	// RC-AUD-2.1 — scene packages (card + audio preset + lighting hint).
	'sceneCards.package': 'Scene package',
	'sceneCards.packageHelp': 'Play the package to start its audio and show the card in one step.',
	'sceneCards.audioPreset': 'Audio preset',
	'sceneCards.audioPresetNone': 'No audio',
	'sceneCards.lightingHint': 'Lighting',
	'sceneCards.lightingNone': 'No lighting note',
	'sceneCards.lighting.bright': 'Bright',
	'sceneCards.lighting.dim': 'Dim',
	'sceneCards.lighting.dark': 'Dark',
	'sceneCards.lighting.firelit': 'Firelit',
	'sceneCards.lighting.moonlit': 'Moonlit',
	'sceneCards.playPackage': 'Play package',
	'sceneCards.packagePlayed': '“{title}” is playing and on the display.',
	'sceneCards.packageShownNoAudio':
		'“{title}” is on the display. The audio preset did not start: {reason}',
	'sceneCards.playPackageFailed': 'The package couldn’t be played — try again.',
	...
	// RC-CHR-1.3 — concentration and death saves on the tracker row.
	'session.combat.concentrating': 'Concentrating',
	'session.combat.concentratingOn': 'Concentrating on {effect}',
	'session.combat.dying': 'Dying',
	'session.combat.deathSaves': 'Death saves {successes} of 3 kept, {failures} of 3 failed',
	'session.combat.deathSaveSuccess': 'Record a death save success for {name}',
	'session.combat.deathSaveFailure': 'Record a death save failure for {name}',
	'session.combat.concCheck': 'Concentration check, DC {dc}',
	'session.combat.concCheckHelp': '{name} took {damage} damage while concentrating on {effect}.',
	'session.combat.concKept': 'Kept it',
	'session.combat.concLost': 'Lost it',
	'session.combat.concKeptFor': 'Keep concentration for {name}',
	'session.combat.concLostFor': 'Drop concentration for {name}',
	...
	'session.combat.initiative.call': 'Roll for initiative',
	'session.combat.initiative.callTitle':
		'Put every player character into the fight and let the players roll from their own devices',
	'session.combat.initiative.needsParty': 'There are no player characters to roll for.',
	'session.combat.initiative.called': 'Initiative called. Players can roll from their devices.',
	'session.combat.initiative.banner': 'Rolling for initiative',
	'session.combat.initiative.help':
		'Rolls land on the rows as players make them. Adjust any number, then start.',
	'session.combat.initiative.progress':
		'{rolled} of {total, plural, one {# character} other {# characters}} rolled',
	'session.combat.initiative.start': 'Start round 1',
	'session.combat.initiative.awaiting': 'Awaiting roll',
	'session.combat.initiative.rolled': 'Rolled {value}',
	'session.combat.initiative.adjusted': 'Adjusted',
	'session.combat.initiative.label': 'Initiative',
	'session.combat.initiative.adjustFor': 'Initiative for {name}',
	'session.combat.initiative.set': 'Set',
	'session.combat.initiative.setToast': '{name} acts on {value}',
	'session.combat.ready.title': 'Table readiness',
	'session.combat.ready.ready': '{name}: ready',
	'session.combat.ready.notReady': '{name}: not ready',
	...
	'settings.about.lastSync': 'Last sync',
	'settings.about.never': 'Never',
	'settings.about.storageTotal': 'Storage used',
	'settings.about.localVault': 'Local vault',
	'settings.about.storage': 'Storage usage',
	'settings.about.colCategory': 'Category',
	'settings.about.colSize': 'Size',
	'settings.about.noStorage': 'No storage usage recorded yet',
	'settings.about.storageCategory.vault': 'Vault',
	'settings.about.storageCategory.cache': 'Cache',
	'settings.about.storageCategory.assets': 'Assets',
	'settings.about.storageCategory.syncQueue': 'Sync queue',
	'settings.about.storageCategory.other': 'Other',
	'settings.about.errors': 'Error counts',
	'settings.about.colCount': 'Count',
	'settings.about.noErrors': 'No errors recorded this session',
	'settings.about.errorCategory.network': 'Network',
	'settings.about.errorCategory.sync': 'Sync',
	'settings.about.errorCategory.storage': 'Storage',
	'settings.about.errorCategory.permission': 'Permission',
	'settings.about.errorCategory.validation': 'Validation',
	'settings.about.errorCategory.render': 'Display',
	'settings.about.errorCategory.unknown': 'Other',
	'settings.about.perf': 'Performance marks',
	'settings.about.colMetric': 'Metric',
	...
	'settings.updates.neverChecked': 'Not checked yet',
	...
	'settings.updates.releaseNotes': "What's new in {version}",
	'settings.updates.status.unsupported': 'Updates unavailable',
	'settings.updates.status.idle': 'Ready to check',
	'settings.updates.status.checking': 'Checking',
	...
	'settings.updates.status.upToDate': 'Up to date',
	'settings.updates.status.error': 'Check failed',
	'settings.updates.upToDateBody': 'You are on the newest build, {version}.',
	'settings.updates.availableBody':
	...
	'shell.sessionRail': 'Session',
	'shell.sessionRailHide': 'Hide the session panel',
	'shell.sessionRailShow': 'Show the session panel',
	'shell.sessionElapsed': 'Elapsed',
	'shell.sessionTurn': 'Current turn',
	'shell.sessionNoTurn': 'No combat running',
	'shell.sessionRound': 'Round {round}',
	// RC-SES-1.2 — the session quick panel (right rail on desktop, sheet elsewhere).
	'session.quick.nextTurn': 'Next turn',
	'session.quick.dice': 'Dice',
	'session.quick.rollDie': 'Roll {expression}',
	'session.quick.custom': 'Custom roll',
	...
	'session.quick.timerModeCountdown': 'Countdown',
	'session.quick.timerModeBreak': 'Break',
	'session.quick.timerModeLabel': 'Timer type',
	'session.quick.timerMinutes': 'Minutes',
	'session.quick.timerLabelPlaceholder': 'Label (optional)',
	'session.quick.timerStart': 'Start',
	'session.quick.timerPause': 'Pause',
	'session.quick.timerResume': 'Resume',
	'session.quick.timerReset': 'Reset',
	'session.quick.timerLap': 'Lap',
	'session.quick.timerLapCount': '{count} lap marks',
	'session.quick.timerBackIn': 'Back in {display}',
	...
	'palette.group.here': 'On this screen',
	...
	'palette.action.advanceCardDone': 'Showing the next card.',
	// RC-CAN-4.3 — the canvas's own verbs, offered in the palette on /board and /scene/:id only.
	'palette.canvas.editLayout': 'Edit layout',
	'palette.canvas.doneEditing': 'Done editing layout',
	'palette.canvas.editKeywords': 'toggle edit mode layout arrange move tiles',
	'palette.canvas.editBlocked': 'Leave the player preview to edit.',
	'palette.canvas.undo': 'Undo last change',
	...
	'play.initiative.title': 'Roll for initiative',
	...
	'play.party.conditionCount': '{count, plural, one {# condition} other {# conditions}}',
	'play.party.concentrating': 'Concentrating on {effect}',
	// RC-CHR-1.3 — the party panel's concentration-check and death-save lines.
	...
	'play.journal.private.addNote': 'Add a note',
	'play.journal.private.noteTitle': 'Title',
	'play.journal.private.noteBody': 'Note',
	'play.journal.private.saveNote': 'Save note',
	'play.journal.private.editNote': 'Edit note: {title}',
	...
	'play.journal.private.removeBookmark': 'Remove bookmark: {title}',
	...
	'play.journal.private.savedLocally': 'Saved on this device.',
	'play.journal.private.deviceOnly': 'On this device',
	'play.journal.private.targetJournal': 'Journal entry',
	'play.journal.private.targetHandout': 'Handout',
	'play.journal.private.targetScene': 'Scene',
	'play.inbox.title': 'Inbox',
	'play.inbox.sub': 'Catch up between sessions — recaps of what happened',
	'play.inbox.count': '{count, plural, one {# recap} other {# recaps}}',
	'play.inbox.empty': 'No recaps yet. Check back after your next session.',
	...
	'settings.ai.conflictIntro':
		'Two edits have diverged. Choose which one the note should keep — approving it as it stands would write nothing.',
	...
	'settings.ai.batchSelectGroup': 'Select all proposed by {agent}',
	...
	'settings.assistant.finished':
		'Assistant finished{staged, plural, =0 {} one { — # change proposed for your review below} other { — # changes proposed for your review below}}.',
	'settings.assistant.finishedTitle': 'Assistant finished',
	'settings.assistant.finishedBody':
		'Your request is done{staged, plural, =0 {.} one { — # change proposed for your review below.} other { — # changes proposed for your review below.}}',
	'settings.assistant.stepLimit':
		'Assistant stopped at the step limit{staged, plural, =0 {} one { — # change proposed for your review below} other { — # changes proposed for your review below}}.',
	...
	// RC-CHR-1.3 — the concentration check damage raised, reported by the player.
	'player.vitals.concCheck': 'Concentration check, DC {dc}',
	'player.vitals.concCheckHelp': 'You took {damage} damage. Roll a Constitution save.',
	'player.vitals.concKept': 'Kept it',
	'player.vitals.concLost': 'Lost it',
	...
	/* Player › Stash (RC-CHR-3.2 — party stash v2, supersedes the v1 stash embedded in Party) */
	'player.stash.title': 'Shared stash',
	'player.stash.emptyTitle': 'The stash is empty',
	'player.stash.emptyBody': 'Items the party finds together go here, ready to claim or split up.',
	'player.stash.removeItem': 'Remove {name}',
	'player.stash.itemRemoved': '“{name}” removed from the stash',
	'player.stash.itemRestored': '“{name}” restored',
	'player.stash.itemName': 'Item name',
	'player.stash.itemNamePlaceholder': 'Item name…',
	'player.stash.itemQuantity': 'Quantity',
	'player.stash.itemWeight': 'Weight (lb)',
	'player.stash.itemDetail': 'Item detail',
	'player.stash.itemDetailPlaceholder': 'Detail (optional)…',
	'player.stash.addToStash': 'Add to stash',
	'player.stash.claim': 'Claim for {character}',
	'player.stash.claimed': '“{name}” claimed for {character}',
	'player.stash.depositItem': 'Item to deposit',
	'player.stash.depositPlaceholder': 'Choose an item…',
	'player.stash.depositQuantity': 'Quantity to deposit',
	'player.stash.deposit': 'Deposit from {character}',
	'player.stash.depositedFrom': 'From {character}',
	'player.stash.recentActivity': 'Recent activity',
	'player.stash.encumbrance.unencumbered': 'Unencumbered ({weight}/{capacity} lb)',
	'player.stash.encumbrance.encumbered': 'Encumbered ({weight}/{capacity} lb)',
	'player.stash.encumbrance.heavilyEncumbered': 'Heavily encumbered ({weight}/{capacity} lb)',
	'player.stash.encumbrance.overloaded': 'Overloaded ({weight}/{capacity} lb)',
	...
	'player.journal.kind.downtime': 'Downtime',
	...
	'player.journal.downtime.section': 'Downtime ({count})',
	'player.journal.downtime.noEntriesTitle': 'No downtime recorded',
	'player.journal.downtime.noEntriesBody':
		'Add a journal entry with the “Downtime” kind to record an activity between adventures.',
	'player.journal.downtime.activity': 'Downtime activity',
	'player.journal.downtime.activityPlaceholder': 'Activity (e.g. Crafting, Carousing)…',
	'player.journal.downtime.days': 'Days spent',
	'player.journal.downtime.cost': 'Cost',
	'player.journal.downtime.costPlaceholder': 'Cost (optional)…',
	'player.journal.downtime.outcome': 'Outcome',
	'player.journal.downtime.outcomePlaceholder': 'Outcome (optional)…',
	'player.journal.downtime.daysValue': '{days, plural, one {# day} other {# days}}',
	'player.journal.downtime.costValue': 'Cost {cost, number}',

	/* Character › History (RC-CHR-2.3) */
	'character.history.title': 'History ({count})',
	'character.history.emptyTitle': 'No history yet',
	'character.history.emptyBody':
		'Journal entries — including downtime — appear here in order as they are written.',
	'character.history.export': 'Export as markdown',
	'character.history.exportTitle': 'Save character history',
	'character.history.exported': 'History exported',
	'character.history.downtimeSummary': '{activity} — {days, plural, one {# day} other {# days}}',
	...
	/* Character › Level up (RC-CHR-2.1) */
	'character.levelUp.level': 'Level {level}',
	'character.levelUp.maxLevel': 'Maximum level reached.',
	'character.levelUp.next': 'Next: level {level}',
	'character.levelUp.experience': 'Experience',
	'character.levelUp.xpMeter': '{xp} / {next} XP',
	'character.levelUp.byXp': '{levelUp} (XP)',
	'character.levelUp.byMilestone': '{levelUp} (milestone)',
	'character.levelUp.fromTo': 'Level {from} → {to}',
	'character.levelUp.modeXp': 'Advancing by experience',
	'character.levelUp.modeMilestone': 'Advancing by milestone',
	'character.levelUp.stepsLabel': 'Level-up steps',
	'character.levelUp.step.class': 'Class',
	'character.levelUp.step.hp': 'Hit points',
	'character.levelUp.step.subclass': 'Subclass',
	'character.levelUp.step.abilityOrFeat': 'Ability or feat',
	'character.levelUp.step.unlocks': 'Unlocked',
	'character.levelUp.step.resources': 'Slots and resources',
	'character.levelUp.step.review': 'Review',
	'character.levelUp.detail.class': 'Name the class gaining this level.',
	'character.levelUp.detail.hp':
		'Roll the hit die or take its average, then save the hit points gained.',
	'character.levelUp.detail.subclass': 'Name the subclass this level unlocks.',
	'character.levelUp.detail.abilityOrFeat':
		'Name the ability score improvement or the feat taken at this level.',
	'character.levelUp.detail.unlocks': 'What the active system grants at the new level.',
	'character.levelUp.detail.resources': 'Which maximums move once the level is finished.',
	'character.levelUp.detail.review': 'Check the choices, then finish the level.',
	'character.levelUp.hitDie': 'Hit die {die}',
	'character.levelUp.noHitDie': 'No hit die on the sheet',
	'character.levelUp.takeAverage': 'Take the average ({value})',
	'character.levelUp.roll': 'Roll {die}',
	'character.levelUp.rollLabel': 'Hit points for level {level}',
	'character.levelUp.rollNeedsSession': 'Start the session to roll here, or take the average.',
	'character.levelUp.rollResult': 'Rolled {die} · {total}',
	'character.levelUp.useRoll': 'Use {total}',
	'character.levelUp.rolled': 'Rolled the hit die.',
	'character.levelUp.saved': '{step} saved as {value}.',
	'character.levelUp.done': 'Level {level} reached.',
	...
	'character.levelUp.slotsAreAuthored':
		'Set spell slots on the Resources tab. They stay as entered on the sheet.',
	'character.levelUp.fromToValue': '{from} → {to}',
	'character.levelUp.notChosen': 'Not chosen',
	'character.levelUp.choose': 'Choose',
	'character.levelUp.change': 'Change',
	'character.levelUp.back': 'Back',
	'character.levelUp.nextStep': 'Next',
	'character.levelUp.discard': 'Discard level-up',
	'character.levelUp.finish': 'Finish — become level {level}',
	'character.levelUp.incomplete': 'Make all choices to finish',
	'character.levelUp.resumeHint': 'Choices save as you make them, so you can leave and come back.',
	...
	'extensions.builder.dialogLabel': 'Widget builder — {name}',
	...
	'extensions.compendium.importLabel': 'Import {name}',
	...
	'extensions.customTypes.editLabel': 'Edit {label}',
	'extensions.customTypes.deleteLabel': 'Delete {label}',
	'extensions.customTypes.confirmDelete': 'Yes, delete {label}',
	'extensions.customTypes.confirmDeleteCount': 'Yes, delete {label} ({count} in vault)',
	...
	'extensions.customTypes.editType': 'Edit “{label}”',
	...
	'extensions.plugins.confirmRemove': 'Yes, remove {name}',
	'extensions.plugins.removeLabel': 'Remove {name}',
	...
	'knowledge.filters.typeNote': 'Notes',
	'knowledge.filters.typeObject': 'Story entries',
	'knowledge.filters.typeOnMap': 'On map',
	'knowledge.filters.typeHandout': 'Handouts',
	'knowledge.filters.typeRoll': 'Rolls',
	'knowledge.filters.tags': 'Tags',
	'knowledge.filters.tagsHelp': 'Separate tags with commas. A result must carry every one.',
	'knowledge.filters.folder': 'Folder',
	'knowledge.filters.linkedTo': 'Linked to',
	'knowledge.filters.linkedToHelp': 'Keep only things linked to this entry.',
	'knowledge.filters.linkedToAny': 'Anything',
	'knowledge.filters.calendar': 'Calendar',
	'knowledge.filters.calendarAny': 'No date range',
	'knowledge.filters.noCalendar': 'Define a calendar to filter by in-world date.',
	'knowledge.filters.dateFrom': 'From',
	'knowledge.filters.dateTo': 'To',
	'knowledge.filters.year': 'Year',
	'knowledge.filters.month': 'Month',
	'knowledge.filters.day': 'Day',
	'knowledge.filters.matches': '{count, plural, one {# match} other {# matches}}',
	'knowledge.filters.facetsApplied':
		'{count, plural, =0 {No filters} one {# filter} other {# filters}}',
	'knowledge.filters.clear': 'Clear filters',
	'knowledge.filters.saveName': 'Name this search',
	'knowledge.filters.saveVisibility': 'Who can see it',
	'knowledge.filters.savePin': 'Pin to the Command Center',
	'knowledge.filters.save': 'Save this search',
	'knowledge.filters.saved': 'Saved searches',
	'knowledge.filters.savedEmpty': 'Nothing saved yet.',
	'knowledge.filters.apply': 'Apply',
	'knowledge.filters.pin': 'Pin',
	'knowledge.filters.unpin': 'Unpin',
	'knowledge.filters.rename': 'Rename',
	'knowledge.filters.saveFailed': 'The search couldn’t be saved — try again.',
	'knowledge.filters.renameFailed': 'The search couldn’t be renamed — try again.',
	'knowledge.filters.pinFailed': 'The pin couldn’t be changed — try again.',
	'knowledge.filters.deleteFailed': 'The search couldn’t be deleted — try again.',
	'knowledge.filters.noResults': 'Nothing matches',
	'knowledge.filters.noResultsBody': 'Loosen a filter, or clear them all to see everything again.',
	...
	'knowledge.filters.deleteBody':
		'The search and its Command Center pin go. The notes it finds stay where they are. This can’t be undone.',
	'knowledge.filters.deleteConfirm': 'Delete search',
	'knowledge.templates': 'Templates',
	'knowledge.templates.sections': 'Template sections',
	'knowledge.templates.tabCreate': 'New from template',
	'knowledge.templates.tabManage': 'Your templates',
	'knowledge.templates.tabSnippets': 'Snippets',
	'knowledge.templates.pick': 'Template',
	'knowledge.templates.yourTemplateOption': '{name} · yours',
	'knowledge.templates.defaultsTo': 'Defaults to {value}',
	'knowledge.templates.createNote': 'Create note',
	'knowledge.templates.createFailed': 'The note couldn’t be created — try again.',
	'knowledge.templates.noneYet':
		'You haven’t saved a template yet. Fill the fields below to add one.',
	'knowledge.templates.name': 'Template name',
	'knowledge.templates.description': 'Description',
	'knowledge.templates.titleTemplate': 'Note title',
	'knowledge.templates.bodyTemplate': 'Note body',
	'knowledge.templates.bodyHelp':
		'Write {{variable}} wherever you want to fill something in. Declare each one below.',
	'knowledge.templates.visibility': 'New notes start as',
	'knowledge.templates.variableName': 'Variable',
	'knowledge.templates.variableLabel': 'Label',
	'knowledge.templates.addVariable': 'Add variable',
	'knowledge.templates.removeVariable': 'Remove variable',
	'knowledge.templates.saveTemplate': 'Save template',
	'knowledge.templates.saveChanges': 'Save changes',
	'knowledge.templates.saveFailed': 'The template couldn’t be saved — try again.',
	'knowledge.templates.snippet': 'Snippet',
	'knowledge.templates.snippetNote': 'Add it to',
	'knowledge.templates.snippetPickNote': 'Pick a note…',
	'knowledge.templates.snippetIntro':
		'A snippet is appended to the note you pick. It keeps that note’s visibility.',
	'knowledge.templates.insertSnippet': 'Insert snippet',
	'knowledge.templates.insertFailed': 'The snippet couldn’t be inserted — try again.',
	'knowledge.templates.snippetAdded': 'Snippet added to “{title}”.',
	'knowledge.templates.saved': 'Saved the template “{name}”.',
	'knowledge.templates.deleted': 'Deleted the template “{name}”.',
	'knowledge.templates.deleteFailed': 'The template couldn’t be deleted — try again.',
	'knowledge.templates.editNamed': 'Edit {name}',
	'knowledge.templates.deleteNamed': 'Delete {name}',
	'knowledge.templates.deleteTitle': 'Delete the template “{name}”?',
	'knowledge.templates.deleteBody':
		'Notes already made from it keep their text. This can’t be undone.',
	'knowledge.templates.deleteConfirm': 'Delete template',
	...
	'knowledge.historyRestore': 'Restore',
	'knowledge.historyShow': 'Show history',
	'knowledge.historyHide': 'Hide history',
	'knowledge.historyLimit':
		'Up to 50 revisions from the last 30 days. Older edits may not have recorded text.',
	'knowledge.historyEmpty': 'No earlier versions recorded yet.',
	'knowledge.historyRevision': 'Revision {revision}',
	'knowledge.historyDelta':
		'{added, plural, one {# line} other {# lines}} added, {removed} removed',
	...
	'knowledge.historyRestored': 'Restored revision {revision}.',
	'knowledge.historyCurrent': 'Revision {revision} · current',
	'knowledge.historyRestoreRevision': 'Restore revision {revision}',
	'knowledge.listHeading': '{count, plural, one {# note} other {# notes}}',
	...
	'audio.presets.applied': 'Applied “{name}”.',
	'audio.presets.saved': 'Saved “{name}” as a scene package.',
	'audio.presets.deleted': 'Deleted “{name}”.',
	'audio.presets.confirmDelete': 'Delete “{name}”?',
	'audio.presets.deleteHelp': 'This removes the saved package. Your current audio keeps playing.',
	'audio.presets.deleting': 'Deleting…',
	'audio.automation.saved': 'Automation rule saved.',
	'audio.automation.deleted': 'Automation “{name}” deleted.',
	'audio.undoFailed': 'Could not undo: {reason}. Try again.',
	...
	'audio.trigger.rollCriticalSuccess': 'Natural 20',
	...
	'audio.sfx.off': 'Turned off',
	'audio.sfx.starterHeading': 'Starter sounds',
	'audio.sfx.starterIntro':
		'Named cues the app ships as recipes. Each one needs a source or an imported file before it can play — no audio comes bundled.',
	'audio.sfx.recentHeading': 'Recent sound effects',
	'audio.sfx.recentEmpty': 'Nothing has fired yet.',
	'audio.sfx.status.played': 'Played',
	'audio.sfx.status.muted': 'Turned off',
	'audio.sfx.status.blocked': 'Nothing played',
	'audio.sfx.status.noRule': 'No rule armed',
	...
	'characters.rosterHeading': 'Character roster',
	'characters.detailsHeading': 'Character details',
	'characters.moreActions': 'More character actions',
	'characters.startingCombat': 'Starting combat…',
	'characters.combatStarted': 'Combat started — open the Session screen to run it.',
	'characters.combatSaveFailed': 'Combat couldn’t be saved. Check your storage and try again.',
	...
	'characters.filter.noOwner': 'No player owner',
	'characters.filter.tag': 'Tag',
	'characters.filter.anyTag': 'Any tag',
	'characters.filter.clear': 'Clear filters',
	...
	'characters.noOwner': 'No player',
	'characters.lastPlayed': 'Last played {when}',
	'characters.playingNow': 'In play now',
	'characters.neverPlayed': 'Not played yet',
	'characters.tags': 'Tags',
	'characters.noTags': 'No tags yet.',
	'characters.tagsPlaceholder': 'Add a tag and press Enter',
	...
	'atlas.mapHierarchy': 'Map hierarchy',
	'atlas.mapHierarchyFilter': 'Filter maps',
	'atlas.mapHierarchyEmpty': 'No maps match “{query}”.',
	'atlas.expandMap': 'Expand {name}',
	'atlas.collapseMap': 'Collapse {name}',
	...
	'sceneEditor.add': 'Add',
	'sceneEditor.emptyTemplatesHint': 'Nothing here yet. Start from a ready-made layout:',
	'sceneEditor.useTemplate': 'Use a template',
	...
	'sceneEditor.transform': 'Position and size',
	'sceneEditor.transformX': 'X',
	...
	'charBuilder.diffTitle': 'Compared with your roster',
	'charBuilder.diffMatch':
		'{name} is already on your roster. Importing adds a second character — the one on the roster is not changed.',
	'charBuilder.diffChanged': '{count, plural, one {# field differs} other {# fields differ}}',
	'charBuilder.diffSame':
		'{count, plural, one {# other field matches} other {# other fields match}}',
	'charBuilder.diffIdentical': 'Every compared field matches the roster copy.',
	'charBuilder.diffNew': 'No character named {name} on your roster yet — this adds a new one.',
	'charBuilder.diffField': 'Field',
	'charBuilder.diffRoster': 'On roster',
	'charBuilder.diffFile': 'In this file',
	'charBuilder.diff.hp': 'Hit points',
	'charBuilder.diff.maxHp': 'Max hit points',
	'charBuilder.diff.ac': 'Armor class',
	'charBuilder.diff.attacks': 'Attacks',
	'charBuilder.diff.spells': 'Spells',
	'charBuilder.diff.skills': 'Skill proficiencies',
	'charBuilder.diff.saves': 'Saving throws',
	...
	'charBuilder.stepCurrent': 'current step',
	'charBuilder.stepTodo': 'not started',
	'charBuilder.goBackTo': 'Go back to {step}',
	...
	'charBuilder.classPreview': '{class} preview',
	'charBuilder.featuresFrom': 'Class features in {system} at level {level}',
	'charBuilder.featureUnlocks': 'from level {level}',
	'charBuilder.featureNeedsSubclass': 'with {subclass}',
	'charBuilder.featureOnSheet': 'set on the sheet',
	'charBuilder.featureDice': '{count} × {die}',
	'charBuilder.recovery.short': 'short rest',
	'charBuilder.recovery.long': 'long rest',
	'charBuilder.recovery.scene': 'each scene',
	'charBuilder.recovery.never': 'does not recover',
	'charBuilder.spellcasting': 'Spellcasting ({ability}) — slots tracked on the sheet',
	'charBuilder.noClassFeatures': '{system} declares no class resources for {class}.',
	...
	'charBuilder.method.roll': 'Roll',
	'charBuilder.method.rollNote': '4d6, drop the lowest die, six times — assign each result once.',
	'charBuilder.method.manual': 'Manual',
	'charBuilder.method.manualNote': 'Set each score yourself — for dice rolled at the table.',
	'charBuilder.pointsLeft': '{points} points left',
	'charBuilder.suggestFor': 'Suggest for {class}',
	'charBuilder.swapWith': '{value} (swap with {ability})',
	'charBuilder.rollScores': 'Roll 4d6 × 6',
	'charBuilder.reroll': 'Reroll all',
	'charBuilder.rolledScores': 'Rolled scores',
	'charBuilder.rollDetail': '{total}: rolled {dice}, dropped {dropped}',
	'charBuilder.rollAnnounce': 'Rolled {totals}, assigned for {class}.',
	'charBuilder.rollFirst': 'Roll the six scores before continuing.',
	'charBuilder.rollIncomplete':
		'Assign all six rolled scores before continuing (unassigned abilities would be saved as 10).',
	...
	'upgrade.planCopy.localFirst': 'Local-first, forever free',
	'upgrade.planCopy.vault': 'On-device campaign vault',
	'upgrade.planCopy.tableTools': 'All table tools, maps & fog',
	'upgrade.planCopy.nearbyPlay': 'Manual and nearby-device play',
	'upgrade.planCopy.ownAssistant': 'Bring-your-own AI assistant',
	'upgrade.planCopy.community': 'Browse community modules',
	'upgrade.planCopy.backup': 'Encrypted off-device backup',
	'upgrade.planCopy.includesHearth': 'Everything in Hearth',
	'upgrade.planCopy.restore': 'Manual restore with the same vault key',
	'upgrade.planCopy.remotePlay': 'Internet remote play',
	'upgrade.planCopy.oneCoDm': '1 Co-{gm} seat',
	'upgrade.planCopy.publishing': 'Publishing and larger tables',
	'upgrade.planCopy.includesLantern': 'Everything in Lantern',
	'upgrade.planCopy.threeCoDms': '3 Co-{gm} seats',
	'upgrade.planCopy.publicWikis': 'Publish public campaign wikis',
	'upgrade.planCopy.publishControls': 'Campaign publishing controls',
	'upgrade.loading': 'Checking your plan…',
	'upgrade.offlineRetry':
		'Your account could not be reached. This comparison may be out of date. Try again when you’re connected.',
	...
	'graph.viewpoint': 'Graph viewpoint',
	'graph.clearFilters': 'Clear filters',
	'graph.results': 'Graph results',
	'graph.repair.retry': 'Try the fix again. If it still fails, reopen the note and check its link.',
	'graph.repair.saving': 'Saving the repaired link…',
	'graph.repair.readOnly': 'Leave preview to repair links.',
	...
	'graph.clusters.toggle': 'Clusters',
	'graph.arcs': '{count, plural, one {# active arc} other {# active arcs}}',
	'graph.dormant.title': 'Dormant arcs',
	'graph.dormant.intro':
		'Groups of linked notes where nothing has changed in the last {days} days.',
	'graph.dormant.empty': 'Every arc has moved recently.',
	'graph.dormant.meta': '{count, plural, one {# note} other {# notes}} · last changed {when}',
	'graph.dormant.never': 'never',
	'graph.repair.entry': 'Repair broken links',
	'graph.repair.back': 'Graph',
	'graph.repair.title': 'Link repair',
	'graph.repair.intro': 'Broken wikilinks in your content, with a suggested fix for each one.',
	...
	'wikiReader.webReader': 'Open text reader',
	'wikiReader.rss': 'Subscribe to recaps',
	'wikiReader.search': 'Search wiki',
	'wikiReader.theme': 'Reader theme',
	'wikiReader.parchment': 'Parchment',
	'wikiReader.light': 'High contrast',
	'wikiReader.dark': 'Dark',
	'wikiReader.noMatches': 'No matching pages',
	'community.wiki.includeRecaps': 'Include shared session recaps',
	'community.wiki.sessionRecap': 'Session recap',
	'community.wiki.recaps': 'Session recaps',
	...
	'boardCanvas.arrange.left': 'Left',
	'boardCanvas.arrange.leftFull': 'Align left',
	'boardCanvas.arrange.center': 'Center',
	'boardCanvas.arrange.centerFull': 'Align centers',
	'boardCanvas.arrange.right': 'Right',
	'boardCanvas.arrange.rightFull': 'Align right',
	'boardCanvas.arrange.top': 'Top',
	'boardCanvas.arrange.topFull': 'Align top',
	'boardCanvas.arrange.middle': 'Middle',
	'boardCanvas.arrange.middleFull': 'Align middles',
	'boardCanvas.arrange.bottom': 'Bottom',
	'boardCanvas.arrange.bottomFull': 'Align bottom',
	'boardCanvas.arrange.distributeH': 'Distribute across',
	'boardCanvas.arrange.distributeHFull': 'Distribute across horizontally',
	'boardCanvas.arrange.distributeV': 'Distribute down',
	'boardCanvas.arrange.distributeVFull': 'Distribute down vertically',
	'boardCanvas.arrange.forward': 'Forward',
	'boardCanvas.arrange.forwardFull': 'Bring forward',
	'boardCanvas.arrange.backward': 'Backward',
	'boardCanvas.arrange.backwardFull': 'Send backward',
	'boardCanvas.arrange.group': 'Group',
	...
	'widgetBody.initiative.compactMore': 'More actions — {name}',
	'widgetBody.initiative.compactActions': 'Quick actions — {name}',
	'widgetBody.initiative.compactCloseActions': 'Close quick actions — {name}',
	'widgetBody.initiative.compactHide': 'Hide {name} from players',
	'widgetBody.initiative.compactReveal': 'Show {name} to players',
	'widgetBody.initiative.compactSwipeHint': 'Swipe a row left for quick actions.',
	...
	'mapDock.categories': 'Categories',
	'mapDock.allCategories': 'All',
	'mapDock.doorsNote': 'These are decorative. Use the Door tool for a door that opens.',
	...
	// RC-MAP-3.10 — "Create note here" from a point of interest.
	...
	'mapPoiNote.type.npcDesc': 'A person the party can meet.',
	'mapPoiNote.type.faction': 'Faction',
	'mapPoiNote.type.factionDesc': 'A group with its own goals.',
	'mapPoiNote.type.note': 'Note',
	'mapPoiNote.type.noteDesc': 'Free prose, no structure.',
	'mapPoiNote.starter.location': '## What the party sees\n\n## Who is here\n\n## Hooks\n',
	'mapPoiNote.starter.npc': '## Appearance\n\n## What they want\n\n## What they know\n',
	'mapPoiNote.starter.faction': '## Goals\n\n## Holdings\n\n## Complications\n',
	'mapPoiNote.starter.note': '## Notes\n',
	...
	'mapVocab.prop.pine': 'Pine',
	'mapVocab.prop.bush': 'Bush',
	'mapVocab.prop.deadTree': 'Dead tree',
	'mapVocab.prop.mushroom': 'Mushrooms',
	'mapVocab.prop.grass': 'Grass tuft',
	'mapVocab.prop.rock': 'Rock',
	'mapVocab.prop.rubble': 'Rubble',
	'mapVocab.prop.bone': 'Bones',
	'mapVocab.prop.stalagmite': 'Stalagmite',
	'mapVocab.prop.grave': 'Grave',
	'mapVocab.prop.table': 'Table',
	'mapVocab.prop.chair': 'Chair',
	'mapVocab.prop.bed': 'Bed',
	'mapVocab.prop.bookshelf': 'Bookshelf',
	'mapVocab.prop.crate': 'Crate',
	'mapVocab.prop.barrel': 'Barrel',
	'mapVocab.prop.altar': 'Altar',
	'mapVocab.prop.chest': 'Chest',
	'mapVocab.prop.coins': 'Coins',
	'mapVocab.prop.gem': 'Gem',
	'mapVocab.prop.urn': 'Urn',
	'mapVocab.prop.doorFrame': 'Doorway',
	'mapVocab.prop.doubleDoors': 'Double doors',
	'mapVocab.prop.secretPanel': 'Secret panel',
	'mapVocab.prop.portcullis': 'Portcullis',
	'mapVocab.prop.stairsUp': 'Stairs up',
	'mapVocab.prop.stairsDown': 'Stairs down',
	'mapVocab.prop.spiralStairs': 'Spiral stairs',
	'mapVocab.prop.ladder': 'Ladder',
	'mapVocab.prop.brazier': 'Brazier',
	'mapVocab.prop.campfire': 'Campfire',
	'mapVocab.prop.torch': 'Torch',
	'mapVocab.prop.chandelier': 'Chandelier',
	'mapVocab.prop.pillar': 'Pillar',
	'mapVocab.prop.statue': 'Statue',
	'mapVocab.prop.well': 'Well',
	'mapVocab.prop.fountain': 'Fountain',
	'mapVocab.propCategory.furniture': 'Furniture',
	'mapVocab.propCategory.foliage': 'Foliage',
	'mapVocab.propCategory.rubble': 'Rubble',
	'mapVocab.propCategory.treasure': 'Treasure',
	'mapVocab.propCategory.doors': 'Doors',
	'mapVocab.propCategory.stairs': 'Stairs',
	'mapVocab.propCategory.light': 'Light',
	'mapVocab.propCategory.structure': 'Structure',
	...
	'toolOptions.stampSize': 'Size',
	'toolOptions.rotateHint': 'Rotation and size apply to the next object you place.',
	...
	'toolOptions.areaSize': 'Size',
	'toolOptions.areaRotation': 'Heading',
	'toolOptions.clearAreas': 'Clear all areas',
	'toolOptions.areasCleared': 'Cleared {count} areas.',
	...
	'mapCombat.token': '{name}. {status}',
	'mapCombat.hp': '{hp} of {maxHp} hit points',
	...
	'mapCombat.moveSurface':
		'Move {name}. Click a highlighted cell, or use the arrow keys and Enter.',
	...
	'mapCombat.areaAffectsNobody': 'Affects nobody',
	'mapInspector.combat': 'Combat',
	'mapInspector.combatRound': 'Round {round} · turn {turn} of {count}',
	'mapInspector.combatActive': 'Active turn',
	...
	'mapTool.combatMove.hint':
		'Select a combatant, then click a highlighted cell — or use the arrow keys and Enter.',
	'mapTool.aoeSphere.label': 'Sphere',
	'mapTool.aoeSphere.hint': 'Click to centre a sphere. Set its radius in the options bar.',
	'mapTool.aoeCone.label': 'Cone',
	'mapTool.aoeCone.hint': 'Click to place a cone. Set its length and heading in the options bar.',
	'mapTool.aoeLine.label': 'Line',
	'mapTool.aoeLine.hint': 'Click to start a line. Set its length and heading in the options bar.',
	'mapTool.aoeCube.label': 'Cube',
	'mapTool.aoeCube.hint': 'Click to place a cube. Set its side and heading in the options bar.',
	...
	'mapEditor.dock.graph': 'Graph',
	// RC-MAP-3.4 — the room graph and the stocking editor.
	'mapGraph.title': 'Rooms and links',
	'mapGraph.empty': 'No rooms yet. Draw a room, or generate a dungeon from the Generate panel.',
	'mapGraph.summary':
		'{rooms, plural, one {# room} other {# rooms}} · {corridors, plural, one {# corridor} other {# corridors}} · {keyed} keyed',
	'mapGraph.unreachable':
		'{count, plural, one {# room has no way in} other {# rooms have no way in}}',
	'mapGraph.noWayIn': 'no way in',
	'mapGraph.nodesLabel': 'Rooms and corridors',
	'mapGraph.roomLabel': '{number}. {name}',
	'mapGraph.links': '{count, plural, one {# link} other {# links}}',
	'mapGraph.stockingFor': 'What is in {name}',
	'mapGraph.stocking.none': 'Not keyed',
	'mapGraph.stocking.empty': 'Empty',
	'mapGraph.stocking.monster': 'Monster',
	'mapGraph.stocking.treasure': 'Treasure',
	'mapGraph.stocking.trap': 'Trap',
	...
	'mapEditor.fogBrush': 'Fog brush',
	'mapEditor.fogBrushSize': 'Fog brush size',
	'mapEditor.zoomedTo': 'Zoomed to {percent}%.',
	...
	// RC-KNW-1.2 — the note editor: formatting toolbar, `[[` autocomplete, `/` insert menu, preview.
	'editor.toolbar': 'Formatting',
	'editor.bold': 'Bold',
	'editor.italic': 'Italic',
	'editor.heading': 'Heading',
	'editor.bulletList': 'List',
	'editor.numberedList': 'Numbered',
	'editor.quote': 'Quote',
	'editor.link': 'Link',
	'editor.table': 'Table',
	'editor.linkText': 'link text',
	'editor.tableColumn': 'Column',
	'editor.viewLabel': 'Editor view',
	'editor.write': 'Write',
	'editor.preview': 'Preview',
	'editor.hint': 'Type [[ to link a note, / to insert a block. Ctrl+B bolds, Ctrl+I italicises.',
	'editor.suggestions': 'Notes to link',
	'editor.insertMenu': 'Blocks to insert',
	'editor.noMatches': 'Nothing matches',
	'editor.statusSaving': 'Saving…',
	'editor.statusSaved': 'Saved {when}',
	'editor.statusUnsaved': 'Unsaved changes',
	'editor.statusUpToDate': 'Up to date',
	'editor.statusFailed': 'Not saved',
	'editor.statusConflict': 'Not saved — changed elsewhere',
	'editor.conflictBody':
		'This note changed somewhere else while you were writing, so nothing was written. Your text is still here — choose which version to keep.',
	'editor.keepMine': 'Keep my version',
	'editor.useSaved': 'Use the other version',
	'editor.slashBlock': 'Block',
	'editor.slashInline': 'Inline',
	'editor.slashCallout': 'Callout',
	'editor.slashTemplate': 'Template',
	'editor.slashSnippet': 'Snippet',
	'editor.slashTableHint': 'Two columns with a header row',
	'editor.slashCalloutLore': 'Lore callout',
	'editor.slashCalloutWarning': 'Warning callout',
	...
	'editor.slashTemplateHint': 'Inserts the outline; fill in the placeholders',
	// RC-KNW-3.1 — the campaign calendar editor.
	...
	'calendar.edit': 'Edit',
	'calendar.empty.title': 'No calendar yet',
	'calendar.empty.body': 'Create one to date notes and set the campaign date.',
	'calendar.summary': '{months} months · {moons} moons · {holidays} holidays',
	'calendar.savedOk': 'Calendar saved',
	'calendar.save': 'Save calendar',
	'calendar.cancel': 'Cancel',
	'calendar.toSession': 'Set the campaign date on Session',
	'calendar.err.name': 'Name the calendar before saving it.',
	'calendar.err.months': 'Name at least one month before saving.',
	'calendar.form.newTitle': 'New calendar',
	'calendar.form.editTitle': 'Edit calendar',
	'calendar.field.name': 'Name',
	'calendar.field.era': 'Era label',
	'calendar.field.eraHint': 'Printed after the year, for example DR.',
	'calendar.field.weekdays': 'Weekdays',
	'calendar.field.weekdaysHint': 'Separate names with commas. Leave empty for no week.',
	'calendar.months.title': 'Months',
	'calendar.months.add': 'Add month',
	'calendar.months.name': 'Month {n}',
	'calendar.months.days': 'Days',
	'calendar.months.remove': 'Remove month {name}',
	'calendar.moons.title': 'Moons',
	'calendar.moons.add': 'Add moon',
	'calendar.moons.hint': 'Phase is derived from the cycle — nothing to keep in step by hand.',
	'calendar.moons.none': 'No moons',
	'calendar.moons.name': 'Name',
	'calendar.moons.cycle': 'Cycle days',
	'calendar.moons.offset': 'Offset',
	'calendar.moons.remove': 'Remove moon {name}',
	'calendar.moons.row': '{name} — {phase}',
	'calendar.holidays.title': 'Holidays',
	'calendar.holidays.add': 'Add holiday',
	'calendar.holidays.none': 'No holidays',
	'calendar.holidays.noneToday': 'Nothing falls on this day',
	'calendar.holidays.name': 'Name',
	'calendar.holidays.month': 'Month',
	'calendar.holidays.day': 'Day',
	'calendar.holidays.remove': 'Remove holiday {name}',
	'calendar.preview.title': 'Preview a date',
	'calendar.phase.new': 'New',
	'calendar.phase.waxingCrescent': 'Waxing crescent',
	'calendar.phase.firstQuarter': 'First quarter',
	'calendar.phase.waxingGibbous': 'Waxing gibbous',
	'calendar.phase.full': 'Full',
	'calendar.phase.waningGibbous': 'Waning gibbous',
	'calendar.phase.lastQuarter': 'Last quarter',
	'calendar.phase.waningCrescent': 'Waning crescent',
	'calendar.note.title': 'Date a note',
	'calendar.note.blurb':
		'Give a note a date in this calendar. It then sorts and reads the same way everywhere.',
	'calendar.note.note': 'Note',
	'calendar.note.field': 'Field',
	'calendar.note.fieldHint': 'The date field name, for example occurredOn.',
	'calendar.note.apply': 'Date note',
	'calendar.note.preview': 'Saves as {date}',
	'calendar.note.datedOk': 'Note dated',
	'calendar.note.noNotes': 'Write a note first, then date it here.',
	...
	/* RC-DSN-3.1 — empty-state illustration gallery (DEV-only route `#/__illustrations`) */
	'ds.illustrations.title': 'Empty-state illustrations',
	'ds.illustrations.intro':
		'Every drawing an empty state can show, once each at full size. The caption names the surface it was drawn for.',
	'ds.illustrations.listHeading': '{count, plural, one {# key} other {# keys}}',
	'ds.illustrations.caption.sessionBoardEmpty': 'Board, before the first tile is placed.',
	'ds.illustrations.caption.noteTileEmpty': 'A note tile with nothing written on it.',
	'ds.illustrations.caption.scenesEmpty': 'Scenes, before the first scene is created.',
	'ds.illustrations.caption.combatIdle': 'Session, when no combat is running.',
	'ds.illustrations.caption.tablesEmpty': 'Random tables, before one is added.',
	'ds.illustrations.caption.playWaiting': 'The player view, waiting for the table to open.',
	'ds.illustrations.caption.audioEmpty': 'Audio, before any sound is added.',
	'ds.illustrations.caption.spellsEmpty': 'A character with no spells or spell slots.',
	'ds.illustrations.caption.knowledgeEmpty': 'Knowledge, before the first page is written.',
	'ds.illustrations.caption.searchNone': 'A search or filter that matched nothing.',
	'ds.illustrations.caption.journalEmpty': 'The player journal, before the first entry.',
	'ds.illustrations.caption.questsEmpty': 'Story quests, before one is started.',
	'ds.illustrations.caption.calendarEmpty': 'The campaign calendar, with no events on it.',
	'ds.illustrations.caption.timelineEmpty': 'The campaign timeline, before anything has happened.',
	'ds.illustrations.caption.graphEmpty': 'The graph, before any links exist.',
	'ds.illustrations.caption.publishEmpty': 'Community publishing, with nothing shared yet.',
	'ds.illustrations.caption.mapLibrary': 'Atlas, before the first map is added.',
	'ds.illustrations.caption.charactersEmpty': 'Characters, before the first one joins the roster.',
	'ds.illustrations.caption.npcsEmpty': 'Story NPCs, before one is introduced.',
	'ds.illustrations.caption.factionsEmpty': 'Story factions, before one is founded.',
	'ds.illustrations.caption.communityEmpty': 'Community, when there is nothing to discover.',
