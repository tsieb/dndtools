...
export const es: Partial<Record<MessageKey, string>> = {
	...
	'vaults.name': 'Nombre de la bóveda',
	'vaults.create': 'Crear bóveda',
	'vaults.rename': 'Renombrar bóveda',
	...
	'sceneDisplay.saving': 'Actualizando la pantalla…',
	'sceneDisplay.saved': 'Pantalla guardada.',
	'sceneDisplay.readOnly': 'La vista previa de jugador es de solo lectura.',
	'sceneDisplay.openFailed': 'No se pudo abrir la pantalla de escena. Inténtalo de nuevo.',
	'sceneDisplay.mood.combat': 'Combate',
	'sceneDisplay.mood.exploration': 'Exploración',
	'sceneDisplay.mood.mystery': 'Misterio',
	'sceneDisplay.mood.social': 'Social',
	'sceneDisplay.mood.rest': 'Descanso',
	'sceneDisplay.waiting': 'Esperando la escena',
	'sceneDisplay.waitingHelp': 'Mantén abierta la ventana principal para mostrar una escena aquí.',
	...
	'sceneCards.package': 'Paquete de escena',
	'sceneCards.packageHelp':
		'Reproduce el paquete para iniciar su audio y mostrar la tarjeta en un paso.',
	'sceneCards.audioPreset': 'Preajuste de audio',
	'sceneCards.audioPresetNone': 'Sin audio',
	'sceneCards.lightingHint': 'Iluminación',
	'sceneCards.lightingNone': 'Sin nota de iluminación',
	'sceneCards.lighting.bright': 'Brillante',
	'sceneCards.lighting.dim': 'Tenue',
	'sceneCards.lighting.dark': 'Oscura',
	'sceneCards.lighting.firelit': 'Con fuego',
	'sceneCards.lighting.moonlit': 'Con luna',
	'sceneCards.playPackage': 'Reproducir paquete',
	'sceneCards.packagePlayed': '«{title}» suena y está en pantalla.',
	'sceneCards.packageShownNoAudio':
		'«{title}» está en pantalla. El preajuste de audio no comenzó: {reason}',
	'sceneCards.playPackageFailed': 'El paquete no se pudo reproducir; inténtalo de nuevo.',
	...
	'session.combat.hp.adjust': 'Ajustar puntos de golpe — {name}',
	'session.combat.hp.sheetTitle': 'Puntos de golpe — {name}',
	'session.combat.hp.sheetHelp':
		'Escribe una cantidad y elige daño, curación o puntos de golpe temporales. Pulsa d o h en el rastreador para abrir esto.',
	'session.combat.hp.current': '{hp} de {max} PG',
	'session.combat.hp.currentWithTemp': '{hp} de {max} PG · {temp} temporales',
	'session.combat.hp.amount': 'Cantidad',
	'session.combat.hp.digit': 'Dígito {digit}',
	'session.combat.hp.backspace': 'Borrar el último dígito',
	'session.combat.hp.clear': 'Borrar la cantidad',
	'session.combat.hp.damage': 'Daño',
	'session.combat.hp.heal': 'Curar',
	'session.combat.hp.temp': 'Temporales',
	'session.combat.hp.needAmount': 'Escribe primero una cantidad.',
	'session.combat.hp.appliedDamage': 'Daño {amount} · {name}',
	'session.combat.hp.appliedHeal': 'Curación {amount} · {name}',
	'session.combat.hp.appliedTemp': 'PG temporales {amount} · {name}',
	...
	'session.combat.initiative.call': 'Tirar iniciativa',
	'session.combat.initiative.callTitle':
		'Mete a todos los personajes jugadores en el combate y deja que los jugadores tiren desde sus dispositivos',
	'session.combat.initiative.needsParty': 'No hay personajes jugadores por los que tirar.',
	'session.combat.initiative.called':
		'Iniciativa pedida. Los jugadores pueden tirar desde sus dispositivos.',
	'session.combat.initiative.banner': 'Tirando iniciativa',
	'session.combat.initiative.help':
		'Las tiradas llegan a las filas a medida que los jugadores las hacen. Ajusta cualquier número y empieza.',
	'session.combat.initiative.progress':
		'{rolled} de {total, plural, one {# personaje} other {# personajes}} han tirado',
	'session.combat.initiative.start': 'Empezar la ronda 1',
	'session.combat.initiative.awaiting': 'Falta tirar',
	'session.combat.initiative.rolled': 'Sacó {value}',
	'session.combat.initiative.adjusted': 'Ajustada',
	'session.combat.initiative.label': 'Iniciativa',
	'session.combat.initiative.adjustFor': 'Iniciativa de {name}',
	'session.combat.initiative.set': 'Fijar',
	'session.combat.initiative.setToast': '{name} actúa en {value}',
	'session.combat.ready.title': 'Quién está listo',
	'session.combat.ready.ready': '{name}: listo',
	'session.combat.ready.notReady': '{name}: no listo',
	...
	'settings.about.localVault': 'Bóveda local',
	'settings.about.storage': 'Uso de almacenamiento',
	'settings.about.colCategory': 'Categoría',
	'settings.about.colSize': 'Tamaño',
	'settings.about.noStorage': 'Aún no se ha registrado uso de almacenamiento',
	'settings.about.storageCategory.vault': 'Bóveda',
	'settings.about.storageCategory.cache': 'Caché',
	'settings.about.storageCategory.assets': 'Recursos',
	'settings.about.storageCategory.syncQueue': 'Cola de sincronización',
	'settings.about.storageCategory.other': 'Otro',
	'settings.about.errors': 'Recuento de errores',
	'settings.about.colCount': 'Cantidad',
	'settings.about.noErrors': 'No se registraron errores en esta sesión',
	'settings.about.errorCategory.network': 'Red',
	'settings.about.errorCategory.sync': 'Sincronización',
	'settings.about.errorCategory.storage': 'Almacenamiento',
	'settings.about.errorCategory.permission': 'Permiso',
	'settings.about.errorCategory.validation': 'Validación',
	'settings.about.errorCategory.render': 'Visualización',
	'settings.about.errorCategory.unknown': 'Otro',
	'settings.about.perf': 'Marcas de rendimiento',
	'settings.about.colMetric': 'Métrica',
	...
	'settings.updates.installedVersion': 'Versión instalada',
	'settings.updates.latestVersion': 'Última versión',
	'settings.updates.lastChecked': 'Última comprobación',
	'settings.updates.neverChecked': 'Sin comprobar todavía',
	'settings.updates.check': 'Buscar actualizaciones',
	'settings.updates.download': 'Descargar actualización',
	'settings.updates.restart': 'Reiniciar para actualizar',
	'settings.updates.releaseNotes': 'Novedades de {version}',
	'settings.updates.status.unsupported': 'Actualizaciones no disponibles',
	'settings.updates.status.idle': 'Listo para comprobar',
	'settings.updates.status.checking': 'Comprobando',
	'settings.updates.status.available': 'Actualización disponible',
	'settings.updates.status.downloading': 'Descargando {percent}%',
	'settings.updates.status.downloaded': 'Lista para instalar',
	'settings.updates.status.upToDate': 'Al día',
	'settings.updates.status.error': 'La comprobación falló',
	'settings.updates.upToDateBody': 'Tienes la versión más reciente, {version}.',
	...
	'shell.sessionRail': 'Sesión',
	'shell.sessionRailHide': 'Ocultar el panel de sesión',
	'shell.sessionRailShow': 'Mostrar el panel de sesión',
	'shell.sessionElapsed': 'Transcurrido',
	'shell.sessionTurn': 'Turno actual',
	'shell.sessionNoTurn': 'No hay combate en curso',
	'shell.sessionRound': 'Ronda {round}',
	// RC-SES-1.2 — el panel rápido de sesión.
	'session.quick.nextTurn': 'Turno siguiente',
	'session.quick.dice': 'Dados',
	'session.quick.rollDie': 'Tirar {expression}',
	'session.quick.custom': 'Tirada personalizada',
	...
	'session.quick.timerModeBreak': 'Descanso',
	'session.quick.timerModeLabel': 'Tipo de temporizador',
	'session.quick.timerMinutes': 'Minutos',
	'session.quick.timerLabelPlaceholder': 'Etiqueta (opcional)',
	'session.quick.timerStart': 'Iniciar',
	'session.quick.timerPause': 'Pausar',
	'session.quick.timerResume': 'Reanudar',
	'session.quick.timerReset': 'Reiniciar',
	'session.quick.timerLap': 'Vuelta',
	'session.quick.timerLapCount': '{count} marcas de vuelta',
	'session.quick.timerBackIn': 'Vuelve en {display}',
	...
	'palette.group.here': 'En esta pantalla',
	'palette.group.actions': 'Acciones',
	'palette.group.objects': 'Entradas de la historia',
	'palette.group.handouts': 'Documentos',
	'palette.group.rolls': 'Tiradas',
	'palette.action.advanceCard': 'Mostrar la siguiente tarjeta de escena',
	'palette.action.advanceCardKeywords': 'cola tarjeta siguiente avanzar mostrar jugadores',
	'palette.action.advanceCardBlocked': 'Pon primero una tarjeta de escena en la cola.',
	'palette.action.advanceCardDone': 'Mostrando la siguiente tarjeta.',
	// RC-CAN-4.3 — los verbos del lienzo, en la paleta solo en /board y /scene/:id.
	'palette.canvas.editLayout': 'Editar el diseño',
	'palette.canvas.doneEditing': 'Terminar de editar el diseño',
	'palette.canvas.editKeywords': 'alternar modo edición diseño organizar mover mosaicos',
	'palette.canvas.editBlocked': 'Sal de la vista previa de jugador para editar.',
	'palette.canvas.undo': 'Deshacer el último cambio',
	...
	'play.initiative.title': 'Tira iniciativa',
	'play.initiative.prompt': 'Tu {gm} pidió iniciativa. Tira por {name}.',
	...
	'play.initiative.rolledToast': 'Iniciativa {total}',
	...
	'play.journal.private.addNote': 'Añadir una nota',
	'play.journal.private.noteTitle': 'Título',
	'play.journal.private.noteBody': 'Nota',
	'play.journal.private.saveNote': 'Guardar nota',
	'play.journal.private.editNote': 'Editar la nota: {title}',
	...
	'play.journal.private.removeBookmark': 'Quitar el marcador: {title}',
	...
	'play.journal.private.savedLocally': 'Guardado en este dispositivo.',
	'play.journal.private.deviceOnly': 'En este dispositivo',
	'play.journal.private.targetJournal': 'Entrada del diario',
	'play.journal.private.targetHandout': 'Documento',
	'play.journal.private.targetScene': 'Escena',
	'play.inbox.title': 'Bandeja',
	'play.inbox.sub': 'Ponte al día entre sesiones — resúmenes de lo que pasó',
	'play.inbox.count': '{count, plural, one {# resumen} other {# resúmenes}}',
	'play.inbox.empty': 'Aún no hay resúmenes. Vuelve después de tu próxima sesión.',
	...
	'settings.ai.batchSelectGroup': 'Seleccionar todo lo propuesto por {agent}',
	...
	'settings.ai.auditMode.staged': 'Propuesto',
	...
	/* Jugador › Alijo (RC-CHR-3.2 — alijo del grupo v2, reemplaza el v1 embebido en Grupo) */
	'player.stash.title': 'Alijo compartido',
	'player.stash.emptyTitle': 'El alijo está vacío',
	'player.stash.emptyBody':
		'Los objetos que el grupo encuentra juntos aparecen aquí, listos para reclamar o repartir.',
	'player.stash.removeItem': 'Quitar {name}',
	'player.stash.itemRemoved': '«{name}» retirado del alijo',
	'player.stash.itemRestored': '«{name}» restaurado',
	'player.stash.itemName': 'Nombre del objeto',
	'player.stash.itemNamePlaceholder': 'Nombre del objeto…',
	'player.stash.itemQuantity': 'Cantidad',
	'player.stash.itemWeight': 'Peso (lb)',
	'player.stash.itemDetail': 'Detalle del objeto',
	'player.stash.itemDetailPlaceholder': 'Detalle (opcional)…',
	'player.stash.addToStash': 'Añadir al alijo',
	'player.stash.claim': 'Reclamar para {character}',
	'player.stash.claimed': '«{name}» reclamado para {character}',
	'player.stash.depositItem': 'Objeto a depositar',
	'player.stash.depositPlaceholder': 'Elige un objeto…',
	'player.stash.depositQuantity': 'Cantidad a depositar',
	'player.stash.deposit': 'Depositar de {character}',
	'player.stash.depositedFrom': 'De {character}',
	'player.stash.recentActivity': 'Actividad reciente',
	'player.stash.encumbrance.unencumbered': 'Sin sobrecarga ({weight}/{capacity} lb)',
	'player.stash.encumbrance.encumbered': 'Cargado ({weight}/{capacity} lb)',
	'player.stash.encumbrance.heavilyEncumbered': 'Muy cargado ({weight}/{capacity} lb)',
	'player.stash.encumbrance.overloaded': 'Sobrecargado ({weight}/{capacity} lb)',
	...
	'player.journal.kind.downtime': 'Tiempo libre',
	...
	'player.journal.downtime.section': 'Tiempo libre ({count})',
	'player.journal.downtime.noEntriesTitle': 'Sin tiempo libre registrado',
	'player.journal.downtime.noEntriesBody':
		'Añade una entrada del diario del tipo «Tiempo libre» para registrar una actividad entre aventuras.',
	'player.journal.downtime.activity': 'Actividad de tiempo libre',
	'player.journal.downtime.activityPlaceholder': 'Actividad (p. ej. Artesanía, Parranda)…',
	'player.journal.downtime.days': 'Días empleados',
	'player.journal.downtime.cost': 'Costo',
	'player.journal.downtime.costPlaceholder': 'Costo (opcional)…',
	'player.journal.downtime.outcome': 'Resultado',
	'player.journal.downtime.outcomePlaceholder': 'Resultado (opcional)…',
	'player.journal.downtime.daysValue': '{days, plural, one {# día} other {# días}}',
	'player.journal.downtime.costValue': 'Costo {cost, number}',

	/* Personaje › Historial (RC-CHR-2.3) */
	'character.history.title': 'Historial ({count})',
	'character.history.emptyTitle': 'Todavía no hay historial',
	'character.history.emptyBody':
		'Las entradas del diario, incluido el tiempo libre, aparecen aquí en el orden en que se escriben.',
	'character.history.export': 'Exportar como markdown',
	'character.history.exportTitle': 'Guardar historial del personaje',
	'character.history.exported': 'Historial exportado',
	'character.history.downtimeSummary': '{activity} — {days, plural, one {# día} other {# días}}',
	...
	/* Personaje › Subir de nivel (RC-CHR-2.1) */
	'character.levelUp.level': 'Nivel {level}',
	'character.levelUp.maxLevel': 'Nivel máximo alcanzado.',
	'character.levelUp.next': 'Siguiente: nivel {level}',
	'character.levelUp.experience': 'Experiencia',
	'character.levelUp.xpMeter': '{xp} / {next} PX',
	'character.levelUp.byXp': '{levelUp} (PX)',
	'character.levelUp.byMilestone': '{levelUp} (hito)',
	'character.levelUp.fromTo': 'Nivel {from} → {to}',
	'character.levelUp.modeXp': 'Avance por experiencia',
	'character.levelUp.modeMilestone': 'Avance por hito',
	'character.levelUp.stepsLabel': 'Pasos de subida de nivel',
	'character.levelUp.step.class': 'Clase',
	'character.levelUp.step.hp': 'Puntos de golpe',
	'character.levelUp.step.subclass': 'Subclase',
	'character.levelUp.step.abilityOrFeat': 'Característica o dote',
	'character.levelUp.step.unlocks': 'Desbloqueado',
	'character.levelUp.step.resources': 'Espacios y recursos',
	'character.levelUp.step.review': 'Revisión',
	'character.levelUp.detail.class': 'Indica la clase que gana este nivel.',
	'character.levelUp.detail.hp':
		'Tira el dado de golpe o toma su promedio y guarda los puntos de golpe ganados.',
	'character.levelUp.detail.subclass': 'Indica la subclase que desbloquea este nivel.',
	'character.levelUp.detail.abilityOrFeat':
		'Indica la mejora de característica o la dote de este nivel.',
	'character.levelUp.detail.unlocks': 'Lo que el sistema activo concede en el nuevo nivel.',
	'character.levelUp.detail.resources': 'Qué máximos cambian al terminar el nivel.',
	'character.levelUp.detail.review': 'Revisa las decisiones y termina el nivel.',
	'character.levelUp.hitDie': 'Dado de golpe {die}',
	'character.levelUp.noHitDie': 'La hoja no tiene dado de golpe',
	'character.levelUp.takeAverage': 'Tomar el promedio ({value})',
	'character.levelUp.roll': 'Tirar {die}',
	'character.levelUp.rollLabel': 'Puntos de golpe del nivel {level}',
	'character.levelUp.rollNeedsSession': 'Inicia la sesión para tirar aquí, o toma el promedio.',
	'character.levelUp.rollResult': 'Tirada {die} · {total}',
	'character.levelUp.useRoll': 'Usar {total}',
	'character.levelUp.rolled': 'Dado de golpe tirado.',
	'character.levelUp.saved': '{step} guardado como {value}.',
	'character.levelUp.done': 'Nivel {level} alcanzado.',
	...
	'character.levelUp.slotsAreAuthored':
		'Ajusta los espacios de conjuro en la pestaña Recursos. Se conservan tal como los introduzcas en la hoja.',
	'character.levelUp.fromToValue': '{from} → {to}',
	'character.levelUp.notChosen': 'Sin elegir',
	'character.levelUp.choose': 'Elegir',
	'character.levelUp.change': 'Cambiar',
	'character.levelUp.back': 'Atrás',
	'character.levelUp.nextStep': 'Siguiente',
	'character.levelUp.discard': 'Descartar subida de nivel',
	'character.levelUp.finish': 'Terminar — pasar a nivel {level}',
	'character.levelUp.incomplete': 'Toma todas las decisiones para terminar',
	'character.levelUp.resumeHint':
		'Las decisiones se guardan al tomarlas, así que puedes salir y volver.',
	...
	'extensions.builder.dialogLabel': 'Constructor de widgets — {name}',
	...
	'extensions.compendium.importLabel': 'Importar {name}',
	...
	'extensions.customTypes.editLabel': 'Editar {label}',
	'extensions.customTypes.deleteLabel': 'Borrar {label}',
	'extensions.customTypes.confirmDelete': 'Sí, borrar {label}',
	'extensions.customTypes.confirmDeleteCount': 'Sí, borrar {label} ({count} en la bóveda)',
	...
	'extensions.customTypes.editType': 'Editar «{label}»',
	...
	'extensions.plugins.confirmRemove': 'Sí, eliminar {name}',
	'extensions.plugins.removeLabel': 'Eliminar {name}',
	...
	// RC-CLD-4.5 — descubrimiento: búsqueda y filtros, la fila destacada, valoraciones.
	'community.discover.searchLabel': 'Buscar módulos',
	'community.discover.searchPlaceholder': 'Busca en nombres y resúmenes',
	'community.discover.filterSystem': 'Sistema',
	'community.discover.systemAny': 'Cualquier sistema',
	'community.discover.filterLicense': 'Licencia',
	'community.discover.licenseAny': 'Cualquier licencia',
	'community.discover.resultCount': '{count, plural, one {# módulo} other {# módulos}}',
	'community.discover.emptySearchTitle': 'Ningún módulo coincide',
	'community.discover.emptySearchBody': 'Prueba con menos palabras o quita un filtro.',
	'community.discover.featured': 'Destacados',
	'community.discover.featuredNote': 'Elegidos por quienes mantienen el mercado.',
	'community.discover.featuredBadge': 'Destacado',
	'community.discover.systemsMeta': 'Para {systems}',
	'community.discover.licenseMeta': 'Licencia: {license}',
	'community.discover.noRatings': 'Aún sin valoraciones',
	'community.discover.ratingSummary':
		'{average} ★ · {count, plural, one {# valoración} other {# valoraciones}}',
	'community.discover.ratingLabel':
		'Valorado con {average} de 5 en {count, plural, one {# valoración} other {# valoraciones}}',
	...
	'community.discover.saveRating': 'Guardar valoración',
	'community.discover.updateRating': 'Actualizar valoración',
	'community.discover.ratingSaved': 'Valoración guardada.',
	'community.discover.loadingReviews': 'Cargando reseñas',
	'community.discover.reviewsFailed': 'No se pudieron cargar las reseñas de este módulo.',
	'community.discover.noReviews': 'Aún no hay reseñas.',
	'community.discover.starsLabel': '{stars, plural, one {# estrella} other {# estrellas}} de 5',
	'community.discover.report': 'Denunciar',
	'community.discover.reportLabel': 'Denunciar esta reseña a quienes mantienen el mercado',
	'community.discover.reported': 'Denunciada. Alguien del equipo la revisará.',
	'community.discover.reportedShort': 'Denunciada',
	'community.discover.installNotRecorded':
		'Se instaló, pero el mercado no pudo registrarlo, así que aún no puedes valorar este módulo.',
	...
	'knowledge.history': 'Historial',
	'knowledge.historyRestore': 'Restaurar',
	'knowledge.historyShow': 'Mostrar historial',
	'knowledge.historyHide': 'Ocultar historial',
	'knowledge.historyLimit':
		'Hasta 50 revisiones de los últimos 30 días. Es posible que las ediciones anteriores no guardaran el texto.',
	'knowledge.historyEmpty': 'Todavía no hay versiones anteriores registradas.',
	'knowledge.historyRevision': 'Revisión {revision}',
	'knowledge.historyDelta':
		'{added, plural, one {# línea añadida} other {# líneas añadidas}}, {removed} eliminadas',
	...
	'knowledge.historyRestored': 'Revisión {revision} restaurada.',
	'knowledge.historyCurrent': 'Revisión {revision} · actual',
	'knowledge.historyRestoreRevision': 'Restaurar la revisión {revision}',
	'knowledge.listHeading': '{count, plural, one {# nota} other {# notas}}',
	...
	'audio.presets.applied': '«{name}» aplicado.',
	'audio.presets.saved': '«{name}» guardado como paquete de escena.',
	'audio.presets.deleted': '«{name}» eliminado.',
	'audio.presets.confirmDelete': '¿Eliminar «{name}»?',
	'audio.presets.deleteHelp': 'Se eliminará el paquete guardado. El audio actual seguirá sonando.',
	'audio.presets.deleting': 'Eliminando…',
	'audio.automation.saved': 'Regla de automatización guardada.',
	'audio.automation.deleted': 'Automatización «{name}» eliminada.',
	'audio.undoFailed': 'No se pudo deshacer: {reason}. Inténtalo de nuevo.',
	...
	// RC-AUD-3.2 — los momentos de mesa con efecto de sonido.
	...
	'audio.sfx.off': 'Apagado',
	'audio.sfx.starterHeading': 'Sonidos iniciales',
	'audio.sfx.starterIntro':
		'Recetas de sonido que incluye la app. Cada una necesita una fuente o un archivo importado antes de poder sonar: no se incluye audio.',
	'audio.sfx.recentHeading': 'Efectos de sonido recientes',
	'audio.sfx.recentEmpty': 'Todavía no ha sonado nada.',
	'audio.sfx.status.played': 'Reproducido',
	'audio.sfx.status.muted': 'Apagado',
	'audio.sfx.status.blocked': 'No sonó nada',
	'audio.sfx.status.noRule': 'Sin regla activa',
	...
	'characters.filter.noOwner': 'Sin jugador propietario',
	'characters.filter.tag': 'Etiqueta',
	'characters.filter.anyTag': 'Cualquier etiqueta',
	'characters.filter.clear': 'Quitar filtros',
	...
	'characters.noOwner': 'Sin jugador',
	'characters.lastPlayed': 'Jugado por última vez {when}',
	'characters.playingNow': 'En juego ahora',
	'characters.neverPlayed': 'Aún sin jugar',
	'characters.tags': 'Etiquetas',
	'characters.noTags': 'Aún no tiene etiquetas.',
	'characters.tagsPlaceholder': 'Añade una etiqueta y pulsa Intro',
	...
	'atlas.mapHierarchy': 'Jerarquía de mapas',
	'atlas.mapHierarchyFilter': 'Filtrar mapas',
	'atlas.mapHierarchyEmpty': 'Ningún mapa coincide con “{query}”.',
	'atlas.expandMap': 'Expandir {name}',
	'atlas.collapseMap': 'Contraer {name}',
	...
	'sceneEditor.transform': 'Posición y tamaño',
	...
	'charBuilder.diffTitle': 'Comparado con tu lista de personajes',
	'charBuilder.diffMatch':
		'{name} ya está en tu lista de personajes. Importar añade un segundo personaje — el de la lista no cambia.',
	'charBuilder.diffChanged': '{count, plural, one {# campo difiere} other {# campos difieren}}',
	'charBuilder.diffSame':
		'{count, plural, one {# campo más coincide} other {# campos más coinciden}}',
	'charBuilder.diffIdentical': 'Todos los campos comparados coinciden con la copia de la lista.',
	'charBuilder.diffNew':
		'Aún no hay ningún personaje llamado {name} en tu lista — esto añade uno nuevo.',
	'charBuilder.diffField': 'Campo',
	'charBuilder.diffRoster': 'En la lista',
	'charBuilder.diffFile': 'En este archivo',
	'charBuilder.diff.hp': 'Puntos de golpe',
	'charBuilder.diff.maxHp': 'Puntos de golpe máximos',
	'charBuilder.diff.ac': 'Clase de armadura',
	'charBuilder.diff.attacks': 'Ataques',
	'charBuilder.diff.spells': 'Conjuros',
	'charBuilder.diff.skills': 'Competencias en habilidades',
	'charBuilder.diff.saves': 'Tiradas de salvación',
	...
	'charBuilder.stepCurrent': 'paso actual',
	'charBuilder.stepTodo': 'sin empezar',
	'charBuilder.goBackTo': 'Volver a {step}',
	...
	'charBuilder.classPreview': 'Vista previa de {class}',
	'charBuilder.featuresFrom': 'Rasgos de clase en {system} a nivel {level}',
	'charBuilder.featureUnlocks': 'desde el nivel {level}',
	'charBuilder.featureNeedsSubclass': 'con {subclass}',
	'charBuilder.featureOnSheet': 'se fija en la hoja',
	'charBuilder.featureDice': '{count} × {die}',
	'charBuilder.recovery.short': 'descanso corto',
	'charBuilder.recovery.long': 'descanso largo',
	'charBuilder.recovery.scene': 'cada escena',
	'charBuilder.recovery.never': 'no se recupera',
	'charBuilder.spellcasting': 'Lanzamiento de conjuros ({ability}) — espacios en la hoja',
	'charBuilder.noClassFeatures': '{system} no declara recursos de clase para {class}.',
	...
	'charBuilder.method.roll': 'Tirada',
	'charBuilder.method.rollNote':
		'4d6 descartando el dado más bajo, seis veces — asigna cada resultado una vez.',
	'charBuilder.method.manual': 'Manual',
	'charBuilder.method.manualNote': 'Fija cada puntuación tú mismo — para dados tirados en la mesa.',
	'charBuilder.pointsLeft': 'Quedan {points} puntos',
	'charBuilder.suggestFor': 'Sugerir para {class}',
	'charBuilder.swapWith': '{value} (intercambiar con {ability})',
	'charBuilder.rollScores': 'Tirar 4d6 × 6',
	'charBuilder.reroll': 'Volver a tirar todo',
	'charBuilder.rolledScores': 'Puntuaciones tiradas',
	'charBuilder.rollDetail': '{total}: salió {dice}, se descarta {dropped}',
	'charBuilder.rollAnnounce': 'Tiradas: {totals}, asignadas para {class}.',
	'charBuilder.rollFirst': 'Tira las seis puntuaciones antes de continuar.',
	'charBuilder.rollIncomplete':
		'Asigna las seis puntuaciones tiradas antes de continuar (las características sin asignar se guardarían como 10).',
	...
	'mapEditor.travelDays': '{value, plural, one {# día} other {# días}}',
	'mapEditor.travelHours': '{value, plural, one {# hora} other {# horas}}',
	'mapEditor.travelAtPace': '{time} a ritmo {pace}',
	'mapEditor.travelNoScale': 'Define una escala del mapa para ver el tiempo de viaje',
	'mapEditor.travelUnitMismatch': 'El tiempo de viaje necesita un mapa en {unit}',
	'mapEditor.travelReadout': 'Viaje de la ruta',
	...
	'upgrade.planCopy.localFirst': 'Local, gratis para siempre',
	'upgrade.planCopy.vault': 'Bóveda de campaña en tu dispositivo',
	'upgrade.planCopy.tableTools': 'Todas las herramientas de mesa, mapas y niebla',
	'upgrade.planCopy.nearbyPlay': 'Juego manual y con dispositivos cercanos',
	'upgrade.planCopy.ownAssistant': 'Conecta tu propio asistente de IA',
	'upgrade.planCopy.community': 'Explora módulos de la comunidad',
	'upgrade.planCopy.backup': 'Copia cifrada fuera del dispositivo',
	'upgrade.planCopy.includesHearth': 'Todo lo incluido en Hearth',
	'upgrade.planCopy.restore': 'Restauración manual con la misma clave de bóveda',
	'upgrade.planCopy.remotePlay': 'Juego remoto por internet',
	'upgrade.planCopy.oneCoDm': '1 plaza de Co-{gm}',
	'upgrade.planCopy.publishing': 'Publicación y mesas más grandes',
	'upgrade.planCopy.includesLantern': 'Todo lo incluido en Lantern',
	'upgrade.planCopy.threeCoDms': '3 plazas de Co-{gm}',
	'upgrade.planCopy.publicWikis': 'Publica wikis de campaña',
	'upgrade.planCopy.publishControls': 'Controles de publicación de campañas',
	'upgrade.loading': 'Consultando tu plan…',
	'upgrade.offlineRetry':
		'No se pudo conectar con tu cuenta. Esta comparación puede estar desactualizada. Vuelve a intentarlo cuando tengas conexión.',
	'upgrade.retry': 'Volver a comprobar',
	...
	'graph.clusters.toggle': 'Grupos',
	'graph.arcs': '{count, plural, one {# arco activo} other {# arcos activos}}',
	'graph.dormant.title': 'Arcos inactivos',
	'graph.dormant.intro':
		'Grupos de notas enlazadas en los que nada ha cambiado en los últimos {days} días.',
	'graph.dormant.empty': 'Todos los arcos se han movido recientemente.',
	'graph.dormant.meta': '{count, plural, one {# nota} other {# notas}} · último cambio {when}',
	'graph.dormant.never': 'nunca',
	...
	'wikiReader.webReader': 'Abrir lector de texto',
	'wikiReader.rss': 'Suscribirse a los resúmenes',
	'wikiReader.search': 'Buscar en la wiki',
	'wikiReader.theme': 'Tema de lectura',
	'wikiReader.parchment': 'Pergamino',
	'wikiReader.light': 'Alto contraste',
	'wikiReader.dark': 'Oscuro',
	'wikiReader.noMatches': 'No hay páginas coincidentes',
	'community.wiki.includeRecaps': 'Incluir resúmenes de sesiones compartidos',
	'community.wiki.sessionRecap': 'Resumen de sesión',
	'community.wiki.recaps': 'Resúmenes de sesiones',
	...
	'boardCanvas.arrange.left': 'Izquierda',
	'boardCanvas.arrange.leftFull': 'Alinear a la izquierda',
	'boardCanvas.arrange.center': 'Centro',
	'boardCanvas.arrange.centerFull': 'Alinear al centro',
	'boardCanvas.arrange.right': 'Derecha',
	'boardCanvas.arrange.rightFull': 'Alinear a la derecha',
	'boardCanvas.arrange.top': 'Arriba',
	'boardCanvas.arrange.topFull': 'Alinear arriba',
	'boardCanvas.arrange.middle': 'Medio',
	'boardCanvas.arrange.middleFull': 'Alinear al medio',
	'boardCanvas.arrange.bottom': 'Abajo',
	'boardCanvas.arrange.bottomFull': 'Alinear abajo',
	'boardCanvas.arrange.distributeH': 'Repartir a lo ancho',
	'boardCanvas.arrange.distributeHFull': 'Repartir a lo ancho horizontalmente',
	'boardCanvas.arrange.distributeV': 'Repartir a lo alto',
	'boardCanvas.arrange.distributeVFull': 'Repartir a lo alto verticalmente',
	'boardCanvas.arrange.forward': 'Adelante',
	'boardCanvas.arrange.forwardFull': 'Traer adelante',
	'boardCanvas.arrange.backward': 'Atrás',
	'boardCanvas.arrange.backwardFull': 'Enviar atrás',
	'boardCanvas.arrange.group': 'Agrupar',
	...
	'mapDock.categories': 'Categorías',
	'mapDock.allCategories': 'Todo',
	'mapDock.doorsNote': 'Son decorativas. Usa la herramienta Puerta para una puerta que se abra.',
	...
	// RC-MAP-3.10 — «Crear una nota aquí» desde un punto de interés.
	...
	'mapPoiNote.type.npcDesc': 'Una persona que el grupo puede conocer.',
	'mapPoiNote.type.faction': 'Facción',
	'mapPoiNote.type.factionDesc': 'Un grupo con sus propios objetivos.',
	'mapPoiNote.type.note': 'Nota',
	'mapPoiNote.type.noteDesc': 'Prosa libre, sin estructura.',
	'mapPoiNote.starter.location': '## Lo que ve el grupo\n\n## Quién está aquí\n\n## Ganchos\n',
	'mapPoiNote.starter.npc': '## Aspecto\n\n## Qué quiere\n\n## Qué sabe\n',
	'mapPoiNote.starter.faction': '## Objetivos\n\n## Posesiones\n\n## Complicaciones\n',
	'mapPoiNote.starter.note': '## Notas\n',
	...
	'mapVocab.prop.pine': 'Pino',
	'mapVocab.prop.bush': 'Arbusto',
	'mapVocab.prop.deadTree': 'Árbol muerto',
	'mapVocab.prop.mushroom': 'Setas',
	'mapVocab.prop.grass': 'Mata de hierba',
	'mapVocab.prop.rock': 'Roca',
	'mapVocab.prop.rubble': 'Escombros',
	'mapVocab.prop.bone': 'Huesos',
	'mapVocab.prop.stalagmite': 'Estalagmita',
	'mapVocab.prop.grave': 'Tumba',
	'mapVocab.prop.table': 'Mesa',
	'mapVocab.prop.chair': 'Silla',
	'mapVocab.prop.bed': 'Cama',
	'mapVocab.prop.bookshelf': 'Estantería',
	'mapVocab.prop.crate': 'Caja',
	'mapVocab.prop.barrel': 'Barril',
	'mapVocab.prop.altar': 'Altar',
	'mapVocab.prop.chest': 'Cofre',
	'mapVocab.prop.coins': 'Monedas',
	'mapVocab.prop.gem': 'Gema',
	'mapVocab.prop.urn': 'Urna',
	'mapVocab.prop.doorFrame': 'Umbral',
	'mapVocab.prop.doubleDoors': 'Puertas dobles',
	'mapVocab.prop.secretPanel': 'Panel secreto',
	'mapVocab.prop.portcullis': 'Rastrillo',
	'mapVocab.prop.stairsUp': 'Escalera ascendente',
	'mapVocab.prop.stairsDown': 'Escalera descendente',
	'mapVocab.prop.spiralStairs': 'Escalera de caracol',
	'mapVocab.prop.ladder': 'Escalera de mano',
	'mapVocab.prop.brazier': 'Brasero',
	'mapVocab.prop.campfire': 'Hoguera',
	'mapVocab.prop.torch': 'Antorcha',
	'mapVocab.prop.chandelier': 'Candelabro',
	'mapVocab.prop.pillar': 'Columna',
	'mapVocab.prop.statue': 'Estatua',
	'mapVocab.prop.well': 'Pozo',
	'mapVocab.prop.fountain': 'Fuente',
	'mapVocab.propCategory.furniture': 'Mobiliario',
	'mapVocab.propCategory.foliage': 'Vegetación',
	'mapVocab.propCategory.rubble': 'Escombros',
	'mapVocab.propCategory.treasure': 'Tesoro',
	'mapVocab.propCategory.doors': 'Puertas',
	'mapVocab.propCategory.stairs': 'Escaleras',
	'mapVocab.propCategory.light': 'Luz',
	'mapVocab.propCategory.structure': 'Estructura',
	...
	'toolOptions.stampSize': 'Tamaño',
	'toolOptions.rotateHint': 'La rotación y el tamaño se aplican al siguiente objeto que coloques.',
	...
	'toolOptions.name': 'Nombre',
	'toolOptions.routeName': 'Nombre de la ruta',
	'toolOptions.routeNamePlaceholder': 'Camino de la costa',
	'toolOptions.pace': 'Ritmo',
	'toolOptions.travelPace': 'Ritmo de viaje',
	'toolOptions.paceOption': '{pace} — {distance} {unit} al día',
	'toolOptions.pace.fast': 'Rápido',
	'toolOptions.pace.normal': 'Normal',
	'toolOptions.pace.slow': 'Lento',
	...
	'mapCombat.hp': '{hp} de {maxHp} puntos de golpe',
	...
	'mapEditor.dock.graph': 'Grafo',
	// RC-MAP-3.4 — el grafo de salas y el editor de contenido.
	'mapGraph.title': 'Salas y conexiones',
	'mapGraph.empty':
		'Aún no hay salas. Dibuja una sala o genera una mazmorra desde el panel Generar.',
	'mapGraph.summary':
		'{rooms, plural, one {# sala} other {# salas}} · {corridors, plural, one {# pasillo} other {# pasillos}} · {keyed} con contenido',
	'mapGraph.unreachable':
		'{count, plural, one {# sala no tiene acceso} other {# salas no tienen acceso}}',
	'mapGraph.noWayIn': 'sin acceso',
	'mapGraph.nodesLabel': 'Salas y pasillos',
	'mapGraph.roomLabel': '{number}. {name}',
	'mapGraph.links': '{count, plural, one {# conexión} other {# conexiones}}',
	'mapGraph.stockingFor': 'Qué hay en {name}',
	'mapGraph.stocking.none': 'Sin contenido',
	'mapGraph.stocking.empty': 'Vacía',
	'mapGraph.stocking.monster': 'Monstruo',
	'mapGraph.stocking.treasure': 'Tesoro',
	'mapGraph.stocking.trap': 'Trampa',
	...
	'mapEditor.fogBrush': 'Pincel de niebla',
	'mapEditor.fogBrushSize': 'Tamaño del pincel de niebla',
	'mapEditor.zoomedTo': 'Zoom al {percent} %.',
	...
	'character.resources.recoversLong': 'Se recupera con un descanso largo',
	'character.resources.recoversScene': 'Se limpia al terminar la escena',
	'character.resources.recoversNever': 'Nunca se recupera solo',
	'character.resources.fromSystem': 'Del sistema activo',
	'character.resources.choose': 'Elige un recurso',
	'character.resources.addFromSystem': 'Añadir',
	'character.resources.customName': 'Nombre',
	'character.resources.customNamePlaceholder': 'Puntos de suerte',
	'character.resources.customMax': 'Máximo',
	'character.resources.customRecovery': 'Se recupera con',
	'character.resources.addCustom': 'Añadir el tuyo',
	'character.resources.customHelp':
		'Un recurso que escribes tú vive solo en este personaje. Uno que ofrece el sistema mantiene su máximo al día según sube de nivel.',
	'character.resources.pipAvailable': '{name} uso {index} disponible',
	'character.resources.pipExpended': '{name} uso {index} gastado',
	'character.resources.pipMarked': '{name} paso {index} marcado',
	...
	// RC-KNW-1.2 — el editor de notas.
	'editor.toolbar': 'Formato',
	'editor.bold': 'Negrita',
	'editor.italic': 'Cursiva',
	'editor.heading': 'Título',
	'editor.bulletList': 'Lista',
	'editor.numberedList': 'Numerada',
	'editor.quote': 'Cita',
	'editor.link': 'Enlace',
	'editor.table': 'Tabla',
	'editor.linkText': 'texto del enlace',
	'editor.tableColumn': 'Columna',
	'editor.viewLabel': 'Vista del editor',
	'editor.write': 'Escribir',
	'editor.preview': 'Vista previa',
	'editor.hint':
		'Escribe [[ para enlazar una nota y / para insertar un bloque. Ctrl+B pone en negrita, Ctrl+I en cursiva.',
	'editor.suggestions': 'Notas para enlazar',
	'editor.insertMenu': 'Bloques para insertar',
	'editor.noMatches': 'No hay coincidencias',
	'editor.statusSaving': 'Guardando…',
	'editor.statusSaved': 'Guardado {when}',
	'editor.statusUnsaved': 'Cambios sin guardar',
	'editor.statusUpToDate': 'Al día',
	'editor.statusFailed': 'Sin guardar',
	'editor.statusConflict': 'Sin guardar — cambió en otro sitio',
	'editor.conflictBody':
		'Esta nota cambió en otro sitio mientras escribías, así que no se guardó nada. Tu texto sigue aquí: elige qué versión conservar.',
	'editor.keepMine': 'Conservar mi versión',
	'editor.useSaved': 'Usar la otra versión',
	'editor.slashBlock': 'Bloque',
	'editor.slashInline': 'En línea',
	'editor.slashCallout': 'Aviso',
	'editor.slashTemplate': 'Plantilla',
	'editor.slashSnippet': 'Fragmento',
	'editor.slashTableHint': 'Dos columnas con fila de encabezado',
	'editor.slashCalloutLore': 'Aviso de trasfondo',
	'editor.slashCalloutWarning': 'Aviso de advertencia',
	...
	'editor.slashTemplateHint': 'Inserta el esquema; rellena los marcadores',
	// RC-KNW-3.1 — el editor del calendario de campaña.
	...
	'calendar.empty.title': 'Aún no hay calendario',
	'calendar.empty.body': 'Crea uno para fechar notas y fijar la fecha de campaña.',
	'calendar.summary': '{months} meses · {moons} lunas · {holidays} festividades',
	'calendar.savedOk': 'Calendario guardado',
	'calendar.save': 'Guardar calendario',
	'calendar.cancel': 'Cancelar',
	'calendar.toSession': 'Fijar la fecha de campaña en Sesión',
	'calendar.err.name': 'Ponle nombre al calendario antes de guardarlo.',
	'calendar.err.months': 'Nombra al menos un mes antes de guardar.',
	'calendar.form.newTitle': 'Nuevo calendario',
	'calendar.form.editTitle': 'Editar calendario',
	'calendar.field.name': 'Nombre',
	'calendar.field.era': 'Etiqueta de era',
	'calendar.field.eraHint': 'Se imprime tras el año, por ejemplo DR.',
	'calendar.field.weekdays': 'Días de la semana',
	'calendar.field.weekdaysHint': 'Separa los nombres con comas. Déjalo vacío si no hay semana.',
	'calendar.months.title': 'Meses',
	'calendar.months.add': 'Añadir mes',
	'calendar.months.name': 'Mes {n}',
	'calendar.months.days': 'Días',
	'calendar.months.remove': 'Quitar el mes {name}',
	'calendar.moons.title': 'Lunas',
	'calendar.moons.add': 'Añadir luna',
	'calendar.moons.hint': 'La fase se deriva del ciclo — no hay nada que ajustar a mano.',
	'calendar.moons.none': 'Sin lunas',
	'calendar.moons.name': 'Nombre',
	'calendar.moons.cycle': 'Días del ciclo',
	'calendar.moons.offset': 'Desfase',
	'calendar.moons.remove': 'Quitar la luna {name}',
	'calendar.moons.row': '{name} — {phase}',
	'calendar.holidays.title': 'Festividades',
	'calendar.holidays.add': 'Añadir festividad',
	'calendar.holidays.none': 'Sin festividades',
	'calendar.holidays.noneToday': 'No cae nada este día',
	'calendar.holidays.name': 'Nombre',
	'calendar.holidays.month': 'Mes',
	'calendar.holidays.day': 'Día',
	'calendar.holidays.remove': 'Quitar la festividad {name}',
	'calendar.preview.title': 'Previsualizar una fecha',
	'calendar.phase.new': 'Nueva',
	'calendar.phase.waxingCrescent': 'Creciente iluminante',
	'calendar.phase.firstQuarter': 'Cuarto creciente',
	'calendar.phase.waxingGibbous': 'Gibosa creciente',
	'calendar.phase.full': 'Llena',
	'calendar.phase.waningGibbous': 'Gibosa menguante',
	'calendar.phase.lastQuarter': 'Cuarto menguante',
	'calendar.phase.waningCrescent': 'Menguante',
	'calendar.note.title': 'Fechar una nota',
	'calendar.note.blurb':
		'Dale a una nota una fecha de este calendario. Así se ordena y se lee igual en todas partes.',
	'calendar.note.note': 'Nota',
	'calendar.note.field': 'Campo',
	'calendar.note.fieldHint': 'El nombre del campo de fecha, por ejemplo occurredOn.',
	'calendar.note.apply': 'Fechar nota',
	'calendar.note.preview': 'Se guarda como {date}',
	'calendar.note.datedOk': 'Nota fechada',
	'calendar.note.noNotes': 'Escribe una nota primero y féchala aquí.',
	...
	'ds.illustrations.title': 'Ilustraciones de estados vacíos',
	'ds.illustrations.intro':
		'Cada dibujo que puede mostrar un estado vacío, una vez cada uno y a tamaño real. El pie indica la superficie para la que se dibujó.',
	'ds.illustrations.listHeading': '{count, plural, one {# clave} other {# claves}}',
	'ds.illustrations.caption.sessionBoardEmpty': 'El tablero, antes de colocar nada en él.',
	'ds.illustrations.caption.noteTileEmpty': 'Una nota sin nada escrito.',
	'ds.illustrations.caption.scenesEmpty': 'Escenas, antes de crear la primera.',
	'ds.illustrations.caption.combatIdle': 'Sesión, cuando no hay ningún combate en curso.',
	'ds.illustrations.caption.tablesEmpty': 'Tablas aleatorias, antes de añadir una.',
	'ds.illustrations.caption.playWaiting': 'La vista del jugador, esperando a que se abra la mesa.',
	'ds.illustrations.caption.audioEmpty': 'Audio, antes de añadir ningún sonido.',
	'ds.illustrations.caption.spellsEmpty': 'Un personaje sin conjuros ni espacios de conjuro.',
	'ds.illustrations.caption.knowledgeEmpty': 'Conocimiento, antes de escribir la primera página.',
	'ds.illustrations.caption.searchNone': 'Una búsqueda o un filtro sin resultados.',
	'ds.illustrations.caption.journalEmpty': 'El diario del jugador, antes de la primera entrada.',
	'ds.illustrations.caption.questsEmpty': 'Misiones de la historia, antes de empezar una.',
	'ds.illustrations.caption.calendarEmpty': 'El calendario de la campaña, sin eventos.',
	'ds.illustrations.caption.timelineEmpty': 'La cronología de la campaña, antes de que pase nada.',
	'ds.illustrations.caption.graphEmpty': 'El grafo, antes de que exista ningún vínculo.',
	'ds.illustrations.caption.publishEmpty':
		'Publicación en la comunidad, sin nada compartido todavía.',
	'ds.illustrations.caption.mapLibrary': 'Atlas, antes de añadir el primer mapa.',
	'ds.illustrations.caption.charactersEmpty':
		'Personajes, antes de que el primero se una al elenco.',
	'ds.illustrations.caption.npcsEmpty': 'PNJ de la historia, antes de presentar uno.',
	'ds.illustrations.caption.factionsEmpty': 'Facciones de la historia, antes de fundar una.',
	'ds.illustrations.caption.communityEmpty': 'Comunidad, cuando no hay nada que descubrir.',
	'ds.illustrations.caption.invitesEmpty': 'Invitaciones de jugadores, antes de enviar una.',
	'ds.illustrations.caption.inventoryEmpty': 'El alijo del grupo, vacío.',
	'ds.illustrations.caption.connectionLost': 'Una lista que no se pudo cargar desde la red.',
	'atlas.library.title': 'Biblioteca de mapas',
	'atlas.library.search': 'Filtrar mapas por nombre o región',
	'atlas.library.help':
		'Usa las flechas para explorar. Pulsa Espacio o Intro para previsualizar un mapa.',
	'atlas.library.loading': 'Cargando mapas…',
	'atlas.library.noRegion': 'Sin región',
	'atlas.library.noMatches': 'No hay mapas coincidentes',
	'atlas.library.empty': 'Tu biblioteca de mapas está vacía',
	'atlas.library.filterHint': 'Prueba otro nombre o región.',
	'atlas.library.emptyHint': 'Crea un mapa para empezar tu atlas.',
	'atlas.library.clear': 'Borrar filtro',
	'atlas.library.pois': '{count} puntos de interés',
	'atlas.library.layer': '{count} capa',
	'atlas.library.layers': '{count} capas',
	...
	'knowledge.filters.noResults': 'Nada coincide',
	'knowledge.filters.noResultsBody': 'Quita un filtro, o bórralos todos para volver a verlo todo.',
	...
	'knowledge.filters.deleteBody':
		'Se eliminan la búsqueda y su fijación en el Centro de mando. Las notas que encuentra se quedan donde están. No se puede deshacer.',
	'knowledge.filters.deleteConfirm': 'Eliminar búsqueda',
	...
	'knowledge.templates.snippetAdded': 'Fragmento añadido a «{title}».',
	'knowledge.templates.saved': 'Plantilla «{name}» guardada.',
	'knowledge.templates.deleted': 'Plantilla «{name}» eliminada.',
	'knowledge.templates.deleteFailed': 'No se pudo eliminar la plantilla. Inténtalo de nuevo.',
	'knowledge.templates.editNamed': 'Editar {name}',
	'knowledge.templates.deleteNamed': 'Eliminar {name}',
	'knowledge.templates.deleteTitle': '¿Eliminar la plantilla «{name}»?',
