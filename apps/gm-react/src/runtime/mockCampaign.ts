/* eslint-disable */
// @ts-nocheck
// Mock campaign data — ported verbatim from the online prototype's campaign-data.js
// (The Sunken Outpost / Brine Hand cult). Visual-fidelity data layer for surfaces the
// Processing Core does not back. Each 'window.DNDX =' became 'export const DNDX ='.
...
// ─────────────────────────────────────────────────────────────────
// ACCOUNT · SUBSCRIPTION · ONLINE SERVICES · COMPLEXITY  (window.DNDAccount)
// The platform-account layer the DM manages outside any one campaign: who they
// are, what plan grants cloud access, what cloud usage they're at, billing, the
// third-party services connected, the devices signed in, and the experience
// complexity that gates progressive disclosure. Same Sunken Outpost continuity.
// ─────────────────────────────────────────────────────────────────
export const DNDAccount = {
  profile: {
    name: 'Sam Rivers', handle: '@samruns', email: 'sam@lanterncompany.table',
    role: 'Dungeon Master', since: 'Joined March 2024', tables: 3, hoursRun: 214,
    pronouns: 'they/them', timezone: 'GMT−5 · Eastern', language: 'English',
  },

  // Experience complexity — gates how much the chrome reveals. Independent of density.
  complexity: {
    active: 'standard',
    levels: [
      { id: 'beginner', name: 'Beginner', icon: 'Sprout',
        blurb: 'The essentials only. Guided prompts, presets over fields, advanced panels hidden until you ask.',
        reveals: ['Guided session prep', 'Preset encounters', 'Auto-applied rules', 'Tooltips everywhere'] },
      { id: 'standard', name: 'Standard', icon: 'SlidersHorizontal', rec: true,
        blurb: 'The full table toolkit with sensible defaults. Most DMs live here.',
        reveals: ['Full combat controls', 'Custom encounters', 'Layered maps & fog', 'Manual rule overrides'] },
      { id: 'expert', name: 'Expert', icon: 'Wrench',
        blurb: 'Everything on, nothing hidden. Code widgets, raw tokens, automation hooks, API surface.',
        reveals: ['Widget code mode', 'Theme token editor', 'MCP / automation', 'Keyboard-only flows'] },
    ],
  },

  // Subscription — local-first is free; cloud is the paid tier.
  subscription: {
    current: 'lantern', renews: 'June 4, 2026', cycle: 'monthly', trialDaysLeft: 0,
    plans: [
      { id: 'hearth', name: 'Hearth', tagline: 'Local-first, forever free', price: 0, period: '', cloud: false,
        features: ['1 device, on-device vault', 'Up to 4 players at the table', 'All core widgets & maps', 'Community modules (read-only)', 'No cloud sync or backup'] },
      { id: 'lantern', name: 'Lantern', tagline: 'Cloud sync for your table', price: 7, period: '/mo', cloud: true, popular: true,
        features: ['Everything in Hearth', 'Cloud sync across devices', 'Up to 6 players + 1 co-DM', '20 GB vault storage', '500 AI assist credits / mo', 'Live audio projection'] },
      { id: 'beacon', name: 'Beacon', tagline: 'For the always-on campaign', price: 15, period: '/mo', cloud: true,
        features: ['Everything in Lantern', 'Up to 12 players + 3 co-DMs', '200 GB vault storage', 'Unlimited AI assist credits', 'Priority sync & support', 'Publish public campaign wikis'] },
    ],
    usage: [
      { id: 'storage', label: 'Vault storage', value: 6.4, max: 20, unit: 'GB', icon: 'vault' },
      { id: 'ai', label: 'AI assist credits', value: 318, max: 500, unit: '', icon: 'sparkle' },
      { id: 'players', label: 'Player seats', value: 4, max: 6, unit: '', icon: 'players' },
      { id: 'codm', label: 'Co-DM seats', value: 1, max: 1, unit: '', icon: 'permissions' },
    ],
    payment: { brand: 'Visa', last4: '4242', exp: '08 / 27', name: 'S. Rivers' },
    nextInvoice: { amount: 7.0, on: 'June 4, 2026' },
    invoices: [
      { id: 'in-0526', date: 'May 4, 2026', amount: 7.0, status: 'paid', plan: 'Lantern · monthly' },
      { id: 'in-0426', date: 'Apr 4, 2026', amount: 7.0, status: 'paid', plan: 'Lantern · monthly' },
      { id: 'in-0326', date: 'Mar 4, 2026', amount: 7.0, status: 'paid', plan: 'Lantern · monthly' },
    ],
  },

  // Online services — OAuth-style third-party connections.
  services: [
    { id: 'google', name: 'Google', kind: 'Sign-in · Docs', icon: 'Chrome', connected: true, account: 'sam@gmail.com', scopes: ['Identity', 'Drive (Session Prep)'] },
    { id: 'discord', name: 'Discord', kind: 'Recap posting · voice', icon: 'MessageCircle', connected: true, account: 'The Lantern Company #table', scopes: ['Post recaps', 'Voice presence'] },
    { id: 'dndbeyond', name: 'D&D Beyond', kind: 'Characters & content', icon: 'Shield', connected: true, account: 'samruns', scopes: ['Read characters', 'Read owned content'] },
    { id: 'patreon', name: 'Patreon', kind: 'Creator payouts', icon: 'Heart', connected: false, account: null, scopes: ['Publish paid modules', 'Receive payouts'] },
    { id: 'dropbox', name: 'Dropbox', kind: 'Vault backup', icon: 'Package', connected: false, account: null, scopes: ['Back up vault', 'Restore'] },
  ],

  // Signed-in devices / live sessions.
  devices: [
    { id: 'dev1', name: 'MacBook Pro', kind: 'This device', where: 'Home · macOS', last: 'Active now', current: true, icon: 'Laptop' },
    { id: 'dev2', name: 'iPad (table)', kind: 'DM screen', where: 'Home · iPadOS', last: '4 min ago', current: false, icon: 'Tablet' },
    { id: 'dev3', name: 'iPhone', kind: 'Companion', where: 'Mobile · iOS', last: 'Yesterday', current: false, icon: 'Smartphone' },
    { id: 'dev4', name: 'Chrome · Windows', kind: 'Web', where: 'Unknown · Chrome', last: '3 weeks ago', current: false, stale: true, icon: 'Monitor' },
  ],

  notifications: [
    { id: 'nt1', label: 'A player joins the live session', on: true },
    { id: 'nt2', label: 'Sync conflicts need resolving', on: true },
    { id: 'nt3', label: 'AI staged a change for review', on: true },
    { id: 'nt4', label: 'Community replies on a published module', on: false },
    { id: 'nt5', label: 'Product news & release notes', on: false },
  ],
};
