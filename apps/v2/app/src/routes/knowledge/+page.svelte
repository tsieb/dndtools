<script lang="ts">
	...
	// CONTENT-001 / CONTENT-002 / CONTENT-005 / CONTENT-006 / CONTENT-011 / CONTENT-012 / CONTENT-013: the
	// Knowledge section. Markdown notes are the PRIMARY content unit (NotesWorkbench: CRUD + recoverable
	// soft-delete/restore + search + the markdown editor with save status, validation, preview, and
	// actor-filtered wikilink assistance). VaultObjects adds STRUCTURED OBJECTS (the schema-validated,
	// note-backed records + the subtype schema registry) and the WIKILINK LIFECYCLE (rename-propagation +
	// repair). It also surfaces calendar/custom-time content, import/export, and the SOURCE-SPECIFIC
