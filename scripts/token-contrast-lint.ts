 ...
 *
 * Parses the per-theme colour tokens from the v2 stylesheet and verifies that every primary
...
const CSS_PATH = resolve(HERE, '..', 'apps', 'v2', 'app', 'src', 'routes', 'styles.css');
